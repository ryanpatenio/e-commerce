"use strict";
(self.webpackChunkdashly = self.webpackChunkdashly || []).push([[613], {
    2042: (e, t, n) => {
        n.r(t),
        n.d(t, {
            BootstrapTheme: () => i,
        ...
        i.prototype.iconOverridePrefix = "bi-";
        const a = (0,
        o.rxu)({
            themeClasses: {
                bootstrap5: i
    ...
    2639: (e, t, n) => {
        ...
        var Pe = {
          ...
          , Qe = function() {
            function e(e) {
                ...
                this.severity = r,
                this.buildFormattingFunc = Be(We)
            }
            ...
            : function(e, t, n) {
                ...
                return function(r) {
                    ...
                    return function(e, t, n, r, o) {
                        ...
                        !1 === r.meridiem ? e = e.replace(ze, "").trim() : "narrow" === r.meridiem ? e = e.replace(ze, (function(e, t) {
                            return t.toLocaleLowerCase()
                        }
                        )) : "short" === r.meridiem ? e = e.replace(ze, (function(e, t) {
                            return t.toLocaleLowerCase() + "m"
                        }
                        )) : "lowercase" === r.meridiem && (e = e.replace(ze, (function(e) {
        ...
        function qe(e) {
            return "object" == typeof e && e ? new Qe(e) : "string" == typeof e ? new Ye(e) : "function" == typeof e ? new Ge(e) : null
        }
        var Je = {
            navLinkDayClick: it,
            navLinkWeekClick: it,
        ...
        function Et(e, t, n, r, o) {
            ...
            if (u)
                return (c = Ct(a, s, t ? t.sourceId : "", u.allDay, Boolean(u.duration), n)).recurringDef = {
                    typeId: u.typeId,
                    typeData: u.typeData,
                    duration: u.duration
                },
            ...
            return d ? {
                def: c = Ct(a, s, t ? t.sourceId : "", d.allDay, d.hasEnd, n),
        ...
        function Ht(e, t, n, r) {
            var o = {}
              ...
              , u = _t(e.defs, t);
            for (var c in e.defs) {
                "inverse-background" === (p = u[(b = e.defs[c]).defId]).display && (b.groupId ? (o[b.groupId] = [],
                a[b.groupId] || (a[b.groupId] = b)) : i[c] = [])
            }
            for (var d in e.instances) {
                var f = e.instances[d]
                  , p = u[(b = e.defs[f.defId]).defId]
                  , h = f.range
                  , v = !b.allDay && r ? St(h, r) : h
                  , g = Mt(v, n);
            ...
            for (var c in i)
                for (var D = 0, w = xt(i[c], n); D < w.length; D++) {
                    E = w[D];
                    s.push({
                        def: e.defs[c],
                        ui: u[c],
        ...
        function jt(e, t, n, r, o, i, a) {
            ...
            var p = f.range.start
              ...
              , y = X(Y(h, -1)).valueOf() === X(Y(g, -1)).valueOf();
          ...
          , hn = function() {
            ...
            e.prototype.setStart = function(e, t) {
                ...
                var n = this._context.dateEnv
                  , r = n.createMarker(e);
                if (r && this._instance) {
                    var o = Rt(this._instance.range.start, r, n, t.granularity);
            ...
            e.prototype.setEnd = function(e, t) {
                ...
                if ((null == e || (n = r.createMarker(e))) && this._instance)
                    if (n) {
                        var o = Rt(this._instance.range.end, n, r, t.granularity);
                        this.mutate({
                            endDelta: o
                        })
                    } else
            ...
            e.prototype.setDates = function(e, t, n) {
                ...
                if (l && ((null == t || (r = a.createMarker(t))) && this._instance)) {
                    ...
                    !0 === n.allDay && (u = Tt(u));
                    var c = Rt(u.start, l, a, n.granularity);
                    if (r) {
                        var d = Rt(u.end, r, a, n.granularity);
                        i = d,
        ...
        var En = function() {
            ...
            e.prototype.countDurationsBetween = function(e, t, n) {
                var r;
                return n.years && null !== (r = this.diffWholeYears(e, t)) ? r / (Te(n) / 365) : n.months && null !== (r = this.diffWholeMonths(e, t)) ? r / function(e) {
                    return Te(e) / 30
                }(n) : n.days && null !== (r = J(e, t)) ? r / Te(n) : (t.valueOf() - e.valueOf()) / Se(n)
            }
            ,
        ...
        var Un = {
          ...
          , zn = function() {
            function e() {
                this.getKeysForEventDefs = Be(this._getKeysForEventDefs),
                this.splitDateSelection = Be(this._splitDateSpan),
                this.splitEventStore = Be(this._splitEventStore),
                this.splitIndividualUi = Be(this._splitIndividualUi),
                this.splitEventDrag = Be(this._splitInteraction),
                this.splitEventResize = Be(this._splitInteraction),
            ...
            return e.prototype.splitProps = function(e) {
                ...
                for (var c in this.eventUiBuilders = ce(n, (function(e, n) {
                    return t.eventUiBuilders[n] || Be(_n)
                }
                )),
                n) {
                    var d = n[c]
        ...
        function Fn(e, t, n, r) {
            return {
                dow: e.getUTCDay(),
                isDisabled: Boolean(r && !Bt(r.activeRange, e)),
                isOther: Boolean(r && !Bt(r.currentRange, e)),
                isToday: Boolean(t && Bt(t, e)),
        ...
        function Jn(e, t, n) {
            ...
            var r = n ? e.getBoundingClientRect() : Xn(e)
              , o = function(e, t) {
                ...
                return Yn() && "rtl" === n.direction ? u.scrollbarLeft = l : u.scrollbarRight = l,
        ...
        function sr(e, t, n, r, o, i, a, s, l, u, c, d, f) {
            return {
                ...
                createScrollResponder: function(e) {
                    return new ir(e,u,Ee(n.scrollTime),n.scrollTimeReset)
                },
        ...
        var Er = function(e) {
            ...
            t.prototype.getInnerContent = function() {
                var e = this.props
                  , t = Tr(e.content, e.hookProps);
                return void 0 === t && (t = Tr(e.defaultContent, e.hookProps)),
                null == t ? null : t
            }
            ,
        ...
        var Mr = function() {
            ...
            e.prototype.buildCurrentRangeInfo = function(e, t) {
                ...
                a = this.buildRangeFromDayCount(e, t, n)) : (a = this.buildCustomVisibleRange(e)) ? i = r.dateEnv.greatestWholeUnit(a.start, a.end).unit : (i = Re(o = this.getFallbackDuration()).unit,
            ...
            e.prototype.buildRangeFromDuration = function(e, t, n, r) {
                ...
                return Te(n) <= 1 && this.isHiddenDay(o) && (o = X(o = this.skipHiddenDays(o, t))),
                d(),
        ...
        function Nr(e, t, n, o) {
            ...
            case "FETCH_EVENT_SOURCES":
                return Ur(e, t.sourceIds ? de(t.sourceIds) : _r(e, o), s, t.isRefetch || !1, o);
            case "RECEIVE_EVENTS":
                    ...
                    return e.split(",").map((function(e) {
                        ...
                        if (n = s[e])
                            ...
                            "prevYear" === e || "nextYear" === e) {
                                ...
                                y = F(c[b] || d[b], [u.year || "year", "year"], u[e])
                            } else
                                y = function(t) {
        ...
        var oo = function() {
            function e(e) {
                var t = this;
                this.computeOptionsData = Be(this._computeOptionsData),
                this.computeCurrentViewData = Be(this._computeCurrentViewData),
                this.organizeRawLocales = Be(Tn),
                this.buildLocale = Be(Sn),
                this.buildPluginHooks = vr(),
                this.buildDateEnv = Be(io),
                this.buildTheme = Be(ao),
                this.parseToolbars = Be(Gr),
                this.buildViewSpecs = Be(xr),
                this.buildDateProfileGenerator = He(so),
                this.buildViewApi = Be(lo),
                this.buildViewUiProps = He(fo),
                this.buildEventUiBySource = Be(uo, pe),
                this.buildEventUiBases = Be(co),
                this.parseContextBusinessHours = He(ho),
                this.buildTitle = Be(ro),
                this.emitter = new $n,
                ...
                Bt(d.activeRange, c) || (c = d.currentRange.start);
                for (var f = {
                    dateEnv: o.dateEnv,
            ...
            e.prototype._handleAction = function(e) {
                ...
                "PREV" !== e.type && "NEXT" !== e.type && Bt(f.currentRange, d) || (d = f.currentRange.start);
                for (var p = Nr(o.eventSources, e, f, c), h = Vr(o.eventStore, e, p, f, c), v = Br(p) && !u.options.progressiveEventRendering && o.renderableEventStore || h, g = this.buildViewUiProps(c), m = g.eventUiSingleBase, y = g.selectionConfig, A = this.buildEventUiBySource(p), b = {
                    ...
                    eventResize: Yr(o.eventResize, e)
                }, E = (0,
                r.pi)((0,
                r.pi)({}, c), b), D = 0, w = s.pluginHooks.reducers; D < w.length; D++) {
                    var C = w[D];
                    (0,
                    r.pi)(b, C(o, e, E))
                }
                var T = po(o, c)
                  , S = po(b, c);
                !T && S ? i.trigger("loading", !0) : T && !S && i.trigger("loading", !1),
                this.state = b,
        ...
        var Io = function(e) {
          ...
          , No = function(e) {
            function t(t) {
                ...
                ,
                n.destroy = T(t.el, "click", ".fc-event", n.handleSegClick),
                n
            }
            return (0,
            r.ZT)(t, e),
          ...
          , Ho = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.buildViewContext = Be(sr),
                t.buildViewPropTransformers = Be(Uo),
                t.buildToolbarProps = Be(Po),
                t.headerRef = s(),
                t.footerRef = s(),
                t.interactionsStore = {},
                t.state = {
                ...
                t.registerInteractiveComponent = function(e, n) {
                    var r = function(e, t) {
                      ...
                      , o = [No, Bo].concat(t.props.pluginHooks.componentInteractions).map((function(e) {
                        return new e(r)
                    }
                    ));
        ...
        function Po(e, t, n, r, o, i) {
            ...
            return {
                ...
                isTodayEnabled: a.isValid && !Bt(t.currentRange, o),
        ...
        var Vo = function(e) {
            ...
            t.prototype.render = function() {
                var e = this.context
                  ...
                  , p = !c.isDisabled && s.colCnt > 1 ? Wn(this.context, l) : {}
                  , h = (0,
                r.pi)((0,
                r.pi)((0,
                r.pi)({
                ...
                return i(yr, {
                    ...
                    r.pi)({
                        ...
                        "data-date": c.isDisabled ? void 0 : Ie(l),
                        colSpan: s.colSpan
          ...
          , Qo = function(e) {
            ...
            t.prototype.render = function() {
                var e = this.props
                  ...
                  , c = [_o].concat(Vn(u, o), e.extraClassNames || [])
          ...
          , Wo = function(e) {
            ...
            t.prototype.computeTiming = function() {
                var e = this.props
                  , t = this.context
                  , n = Y(this.initialNowDate, (new Date).valueOf() - this.initialNowQueriedMs)
        ...
        var jo = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.createDayHeaderFormatter = Be(Yo),
                t
            }
            return (0,
            r.ZT)(t, e),
        ...
        var Go = function() {
          ...
          , Jo = function() {
            function e() {
                this.sliceBusinessHours = Be(this._sliceBusinessHours),
                this.sliceDateSelection = Be(this._sliceDateSpan),
                this.sliceEventStore = Be(this._sliceEventStore),
            ...
            e.prototype._sliceInteraction = function(e, t, n, r) {
                ...
                if (!e)
                    return null;
                var a = Ht(e.mutatedEvents, t, Xo(n, Boolean(r)), r);
                return {
        ...
        function ti(e, t, n, o) {
            ...
            !(e.eventDrag && !function(e, t, n, o) {
                var i = t.getCurrentData()
                  ...
                  , l = s.defs
                  , u = s.instances
                  , c = _t(l, a.isEvent ? e.eventUiBases : {
                    "": i.selectionConfig
                });
                o && (c = ce(c, o));
                ...
                for (var m in u) {
                    ...
                    for (var C in p) {
                        var T = p[C];
                        if (Ot(A, T.range)) {
                            if (!1 === h[T.defId].overlap && a.isEvent)
                                return !1;
                            if (!1 === b.overlap)
                                return !1;
                            if (w && !w(new hn(t,f[T.defId],T), new hn(t,E,y)))
                                return !1
                        }
                    }
                    for (var S = i.eventStore, k = 0, R = b.allows; k < R.length; k++) {
                        ...
                        r.pi)({}, n), {
                          ...
                          , O = S.instances[m]
                          , N = void 0;
                        if (N = M ? new hn(t,M,O) : new hn(t,E),
                        !x(nn(I, t), N))
                            return !1
                    }
                }
        ...
        var yi = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.processCols = Be((function(e) {
                    return e
                }
                ), di),
                t.renderMicroColGroup = Be(fi),
        ...
        var Si = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.refineHookProps = He(Ti),
        ...
        function Ui(e) {
            return e.reduce(zi).eventRange.range.start
        }
        function zi(e, t) {
