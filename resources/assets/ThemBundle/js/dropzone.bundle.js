"use strict";
(self.webpackChunkdashly = self.webpackChunkdashly || []).push([[650], {
    247: (e, t, i) => {
        i.r(t),
        i.d(t, {
            Dropzone: () => a,
        ...
        var s = function e() {
            ...
            for (var n = t.slice(1), o = n.length, r = 0; r < o; r++) {
                var a = n[r];
                for (var d in a)
                    if (Object.prototype.hasOwnProperty.call(a, d)) {
                        var h = a[d];
                        if (i && (p = h,
                        Array.isArray(p) || "[object Object]" == {}.toString.call(p))) {
                            var u = Array.isArray(h) ? [] : {};
                            s[d] = e(!0, Object.prototype.hasOwnProperty.call(s, d) && !l(s[d]) ? s[d] : u, h)
                        } else
                            s[d] = h
                    }
            }
        ...
        class o {
            ...
            makeEvent(e, t) {
                ...
                return s.initCustomEvent(e, i.bubbles, i.cancelable, i.detail),
                s
            }
            off(e, t) {
        ...
        var r = {
            ...
            fallback() {
                ...
                e || (e = a.createElement('<div class="dz-message"><span></span></div>'),
            ...
            resize(e, t, i, s) {
                let l = {
                  ...
                  , n = e.width / e.height;
                null == t && null == i ? (t = l.srcWidth,
                i = l.srcHeight) : null == t ? t = i * n : null == i && (i = t / n);
                let o = (t = Math.min(t, l.srcWidth)) / (i = Math.min(i, l.srcHeight));
                if (l.srcWidth > t || l.srcHeight > i)
                    if ("crop" === s)
                        n > o ? (l.srcHeight = e.height,
                        l.srcWidth = l.srcHeight * o) : (l.srcWidth = e.width,
                        l.srcHeight = l.srcWidth / o);
                    else {
                        if ("contain" !== s)
                            throw new Error(`Unknown resizeMethod '${s}'`);
                        n > o ? i = t / n : t = i * n
                    }
                return l.srcX = (e.width - l.srcWidth) / 2,
                l.srcY = (e.height - l.srcHeight) / 2,
                l.trgWidth = t,
                l.trgHeight = i,
                l
            },
            ...
            addedfile(e) {
                ...
                this.previewsContainer && !this.options.disablePreviews) {
                    for (var t of (e.previewElement = a.createElement(this.options.previewTemplate.trim()),
                    ...
                    this.options.addRemoveLinks && (e._removeLink = a.createElement(`<a class="dz-remove" href="javascript:undefined;" data-dz-remove>${this.options.dictRemoveFile}</a>`),
                    e.previewElement.appendChild(e._removeLink));
                    let i = t => (t.preventDefault(),
                    t.stopPropagation(),
                    e.status === a.UPLOADING ? a.confirm(this.options.dictCancelUploadConfirmation, ( () => this.removeFile(e))) : this.options.dictRemoveFileConfirmation ? a.confirm(this.options.dictRemoveFileConfirmation, ( () => this.removeFile(e))) : this.removeFile(e));
        ...
        class a extends o {
            ...
            getActiveFiles() {
                return this.files.filter((e => e.status === a.UPLOADING || e.status === a.QUEUED)).map((e => e))
            }
            init() {
                if ("form" === this.element.tagName && this.element.setAttribute("enctype", "multipart/form-data"),
                this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message") && this.element.appendChild(a.createElement(`<div class="dz-default dz-message"><button class="dz-button" type="button">${this.options.dictDefaultMessage}</button></div>`)),
                this.clickableElements.length) {
                    let e = () => {
                        ...
                        a.getElement(this.options.hiddenInputContainer, "hiddenInputContainer").appendChild(this.hiddenFileInput),
                ...
                this.clickableElements.forEach((e => this.listeners.push({
                    element: e,
                    events: {
                        click: t => ((e !== this.element || t.target === this.element || a.elementInside(t.target, this.element.querySelector(".dz-message"))) && this.hiddenFileInput.click(),
                        !0)
                    }
                }))),
                this.enable(),
            ...
            getFallbackForm() {
                ...
                return "FORM" !== this.element.tagName ? (t = a.createElement(`<form action="${this.options.url}" enctype="multipart/form-data" method="${this.options.method}"></form>`),
                t.appendChild(s)) : (this.element.setAttribute("enctype", "multipart/form-data"),
            ...
            filesize(e) {
                ...
                if (e > 0) {
                    ...
                    for (let l = 0; l < s.length; l++) {
                        let n = s[l];
                        if (e >= Math.pow(this.options.filesizeBase, 4 - l) / 10) {
                            t = e / Math.pow(this.options.filesizeBase, 4 - l),
                            i = n;
                            break
                        }
                    }
            ...
            _addFilesFromItems(e) {
                return ( () => {
                    ...
                    for (let s of e) {
                        var i;
                        null != s.webkitGetAsEntry && (i = s.webkitGetAsEntry()) ? i.isFile ? t.push(this.addFile(s.getAsFile())) : i.isDirectory ? t.push(this._addFilesFromDirectory(i, i.name)) : t.push(void 0) : null != s.getAsFile && (null == s.kind || "file" === s.kind) ? t.push(this.addFile(s.getAsFile())) : t.push(void 0)
                    }
                    return t
                }
                )()
            ...
            accept(e, t) {
                this.options.maxFilesize && e.size > 1048576 * this.options.maxFilesize ? t(this.options.dictFileTooBig.replace("{{filesize}}", Math.round(e.size / 1024 / 10.24) / 100).replace("{{maxFilesize}}", this.options.maxFilesize)) : a.isValidFile(e, this.options.acceptedFiles) ? null != this.options.maxFiles && this.getAcceptedFiles().length >= this.options.maxFiles ? (t(this.options.dictMaxFilesExceeded.replace("{{maxFiles}}", this.options.maxFiles)),
            ...
            enqueueFile(e) {
                if (e.status !== a.ADDED || !0 !== e.accepted)
                    throw new Error("This file can't be queued because it has already been processed or was rejected.");
                if (e.status = a.QUEUED,
            ...
            removeFile(e) {
                if (e.status === a.UPLOADING && this.cancelUpload(e),
            ...
            removeAllFiles(e) {
                ...
                for (let t of this.files.slice())
                    (t.status !== a.UPLOADING || e) && this.removeFile(t);
                return null
            }
            resizeImage(e, t, i, s, l) {
                return this.createThumbnail(e, t, i, s, !0, ( (t, i) => {
                        ...
                        return l(e);
                    {
                        ...
                        return "image/jpeg" !== t && "image/jpg" !== t || (s = p.restore(e.dataURL, s)),
                        l(a.dataURItoBlob(s))
                    }
                }
                ))
            }
            createThumbnail(e, t, i, s, l, n) {
                let o = new FileReader;
                o.onload = () => {
                    e.dataURL = o.result,
                    "image/svg+xml" !== e.type ? this.createThumbnailFromUrl(e, t, i, s, l, n) : null != n && n(o.result)
                }
                ,
                o.readAsDataURL(e)
            }
            displayExistingFile(e, t, i, s, l=!0) {
                ...
                l) {
                    ...
                    ;
                    e.dataURL = t,
                    this.createThumbnailFromUrl(e, this.options.thumbnailWidth, this.options.thumbnailHeight, this.options.thumbnailMethod, this.options.fixOrientation, l, s)
                } else
                    this.emit("thumbnail", e, t),
                    i && i()
            }
            createThumbnailFromUrl(e, t, i, s, l, n, o) {
                let r = document.createElement("img");
                return o && (r.crossOrigin = o),
                l = "from-image" != getComputedStyle(document.body).imageOrientation && l,
                r.onload = () => {
                    let o = e => e(1);
                    return "undefined" != typeof EXIF && null !== EXIF && l && (o = e => EXIF.getData(r, (function() {
                    ...
                    o((l => {
                        e.width = r.width,
                        e.height = r.height;
                        let o = this.options.resize.call(this, e, t, i, s)
                          , a = document.createElement("canvas")
                          , d = a.getContext("2d");
                        switch (a.width = o.trgWidth,
                        a.height = o.trgHeight,
                        l > 4 && (a.width = o.trgHeight,
                        a.height = o.trgWidth),
                        l) {
                        case 2:
                        ...
                        case 6:
                            d.rotate(.5 * Math.PI),
                            d.translate(0, -a.width);
                            break;
                        case 7:
                            d.rotate(.5 * Math.PI),
                            d.translate(a.height, -a.width),
                            d.scale(-1, 1);
                            break;
                        case 8:
                            d.rotate(-.5 * Math.PI),
                            d.translate(-a.height, 0)
                        }
                        u(d, r, null != o.srcX ? o.srcX : 0, null != o.srcY ? o.srcY : 0, o.srcWidth, o.srcHeight, null != o.trgX ? o.trgX : 0, null != o.trgY ? o.trgY : 0, o.trgWidth, o.trgHeight);
                        let h = a.toDataURL("image/png");
                        if (null != n)
                            return n(h, a)
                    }
                    ))
            ...
            cancelUpload(e) {
                if (e.status === a.UPLOADING) {
                    ...
                    e.status !== a.ADDED && e.status !== a.QUEUED || (e.status = a.CANCELED,
                    this.emit("canceled", e),
                    ...
                    if (e[0].upload.chunked) {
                        ...
                        let n = () => {
                            ...
                            if (t >= i.upload.totalChunkCount)
                                return;
                            l++;
                            let n = t * this.options.chunkSize
                              , o = Math.min(n + this.options.chunkSize, s.size)
                              , r = {
                                name: this._getParamName(0),
                                data: s.webkitSlice ? s.webkitSlice(n, o) : s.slice(n, o),
                        ...
                        ;
                        if (i.upload.finishedChunkUpload = (t, s) => {
                            let l = !0;
                            t.status = a.SUCCESS,
                            t.dataBlock = null,
                            ...
                            for (let e = 0; e < i.upload.totalChunkCount; e++) {
                                if (void 0 === i.upload.chunks[e])
                                    return n();
                                i.upload.chunks[e].status !== a.SUCCESS && (l = !1)
                            }
            ...
            _uploadData(e, t) {
                ...
                let l = this.resolveOption(this.options.method, e, t)
                  , n = this.resolveOption(this.options.url, e, t);
                i.open(l, n, !0),
                ...
                this.options.headers && s(o, this.options.headers);
                for (let e in o) {
                    let t = o[e];
                ...
                if (this.options.binaryBody) {
                    ...
                    for (let t of e)
                        this.emit("sending", t, i, s);
                    this.options.uploadMultiple && this.emit("sendingmultiple", e, i, s),
                    this._addFormElementData(s);
                    for (let e = 0; e < t.length; e++) {
                        let i = t[e];
                        s.append(i.name, i.data, i.filename)
                    }
                    this.submitRequest(i, s, e)
                }
            }
            _transformFiles(e, t) {
                let i = []
                ...
                for (let l = 0; l < e.length; l++)
                    this.options.transformFile.call(this, e[l], (n => {
                        i[l] = n,
                        ++s === e.length && t(i)
                    }
                    ))
                    ...
                    for (let t of this.element.querySelectorAll("input, textarea, select, button")) {
                        ...
                        null != i)
                            if ("SELECT" === t.tagName && t.hasAttribute("multiple"))
                                ...
                                (!s || "checkbox" !== s && "radio" !== s || t.checked) && e.append(i, t.value)
                    }
            }
            _updateFilesUploadProgress(e, t, i) {
                if (e[0].upload.chunked) {
                    let s = e[0]
                      , l = this._getChunk(s, t);
                    i ? (l.progress = 100 * i.loaded / i.total,
                    l.total = i.total,
                    l.bytesSent = i.loaded) : (l.progress = 100,
                    l.bytesSent = l.total),
                    s.upload.progress = 0,
                    s.upload.total = 0,
                    s.upload.bytesSent = 0;
                    for (let e = 0; e < s.upload.totalChunkCount; e++)
                        s.upload.chunks[e] && void 0 !== s.upload.chunks[e].progress && (s.upload.progress += s.upload.chunks[e].progress,
            ...
            _finishedUploading(e, t, i) {
                ...
                if (e[0].status !== a.CANCELED && 4 === t.readyState) {
                    if ("arraybuffer" !== t.responseType && "blob" !== t.responseType && (s = t.responseText,
                    ...
                    200 <= t.status && t.status < 300 ? e[0].upload.chunked ? e[0].upload.finishedChunkUpload(this._getChunk(e[0], t), s) : this._finished(e, s, i) : this._handleUploadError(e, t, s)
                }
            }
            ...
            constructor(e, t) {
                ...
                let n = null != (l = a.optionsForElement(this.element)) ? l : {};
                if (this.options = s(!0, {}, r, n, null != t ? t : {}),
                ...
                !1 !== this.options.previewsContainer && (this.options.previewsContainer ? this.previewsContainer = a.getElement(this.options.previewsContainer, "previewsContainer") : this.previewsContainer = this.element),
                this.options.clickable && (!0 === this.options.clickable ? this.clickableElements = [this.element] : this.clickableElements = a.getElements(this.options.clickable, "clickable")),
                this.init()
            }
        }
        a.initClass(),
        ...
        a.optionsForElement = function(e) {
            return e.getAttribute("id") ? a.options[h(e.getAttribute("id"))] : void 0
        }
        ,
        a.instances = [],
        ...
        a.discover = function() {
            ...
            return ( () => {
                let t = [];
                for (let i of e)
                    !1 !== a.optionsForElement(i) ? t.push(new a(i)) : t.push(void 0);
                return t
            }
            )()
        }
        ,
        a.blockedBrowsers = [/opera.*(Macintosh|Windows Phone).*version\/12/i],
        a.isBrowserSupported = function() {
            let e = !0;
            if (window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector)
                if ("classList"in document.createElement("a")) {
                    void 0 !== a.blacklistedBrowsers && (a.blockedBrowsers = a.blacklistedBrowsers);
                    for (let t of a.blockedBrowsers)
        ...
        a.dataURItoBlob = function(e) {
            let t = atob(e.split(",")[1])
              ...
              , l = new Uint8Array(s);
            for (let e = 0, i = t.length, s = 0 <= i; s ? e <= i : e >= i; s ? e++ : e--)
                l[e] = t.charCodeAt(e);
            return new Blob([s],{
                type: i
            })
        ...
        ;
        const d = (e, t) => e.filter((e => e !== t)).map((e => e))
          , h = e => e.replace(/[\-_](\w)/g, (e => e.charAt(1).toUpperCase()));
        ...
        a.ERROR = "error",
        a.SUCCESS = "success";
        var u = function(e, t, i, s, l, n, o, r, a, d) {
            let h = function(e) {
                e.naturalWidth;
                ...
                s.drawImage(e, 0, 0);
                let {data: l} = s.getImageData(1, 0, 1, t)
                  , n = 0
                  , o = t
                  , r = t;
                for (; r > n; )
            ...
            return e.drawImage(t, i, s, l, n, o, r, a, d / h)
        };
        class p {
            static initClass() {
            ...
            static encode64(e) {
                ...
                n = (15 & i) << 2 | r >> 6,
                a = 63 & r,
                isNaN(i) ? n = a = 64 : isNaN(r) && (a = 64),
                o = o + this.KEY_STR.charAt(s) + this.KEY_STR.charAt(l) + this.KEY_STR.charAt(n) + this.KEY_STR.charAt(a),
                t = i = r = "",
                s = l = n = a = "",
                d < e.length; )
                    ;
            ...
            static decode64(e) {
                let t, i, s, l, n, o = "", r = "", a = 0, d = [];
                for (/[^A-Za-z0-9\+\/\=]/g.exec(e) && console.warn("There were invalid base64 characters in the input text.\nValid base64 characters are A-Z, a-z, 0-9, '+', '/',and '='\nExpect errors in decoding."),
                e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); s = this.KEY_STR.indexOf(e.charAt(a++)),
