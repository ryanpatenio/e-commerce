(self.webpackChunkdashly = self.webpackChunkdashly || []).push([[483], {
    2584: e => {
    ...
    1808: (e, t, n) => {
        ...
        n.g.addEventListener || (u = function(e, t, r) {
        ...
        e.exports = {
            ...
            fabricate: function(e, t, n) {
                ...
                e.dispatchEvent ? e.dispatchEvent(u) : e.fireEvent("on" + t, u)
            }
        }
    }
    ,
    ...
    7137: (e, t, n) => {
        ...
        function f(e, t) {
            return void 0 !== n.g[t] ? n.g[t] : c.clientHeight ? c[e] : u.body[e]
        }
        function v(e, t, n) {
            var r, o = (e = e || {}).className || "";
        ...
        function b(e) {
            return !!e && ("false" !== e.contentEditable && ("true" === e.contentEditable || b(g(e))))
        }
        function y(e) {
        ...
        e.exports = function(e, t) {
            ...
            void 0 === I.isContainer && (I.isContainer = s),
            ...
            void 0 === I.mirrorContainer && (I.mirrorContainer = u.body);
            var M = r({
            ...
            return !0 === I.removeOnSpill && M.on("over", (function(e) {
                i.rm(e, "gu-hide")
            }
            )).on("out", (function(e) {
                M.dragging && i.add(e, "gu-hide")
            }
            )),
            D(),
            M;
            function k(e) {
                return -1 !== M.containers.indexOf(e) || I.isContainer(e)
            }
            function D(e) {
                var t = e ? "remove" : "add";
                a(c, t, "mousedown", F),
            ...
            function F(e) {
                ...
                !(1 !== l(e) || e.metaKey || e.ctrlKey)) {
                    ...
                    n && (B = n,
                    R(),
                    "mousedown" === e.type && (h(t) ? t.focus() : e.preventDefault()))
                }
            }
            function j(e) {
                if (B)
                    if (0 !== l(e)) {
                        if (!(void 0 !== e.clientX && Math.abs(e.clientX - x) <= (I.slideFactorX || 0) && void 0 !== e.clientY && Math.abs(e.clientY - T) <= (I.slideFactorY || 0))) {
                            if (I.ignoreInputTextSelection) {
                                var t = E("clientX", e) || 0
                                  , r = E("clientY", e) || 0;
                                if (h(u.elementFromPoint(t, r)))
                                    return
                            }
                            var o = B;
                            R(!0),
                            ...
                            U(o);
                            var v, s = {
                                left: (v = S.getBoundingClientRect()).left + f("scrollLeft", "pageXOffset"),
                                top: v.top + f("scrollTop", "pageYOffset")
                            };
                            C = E("pageX", e) - s.left,
                            w = E("pageY", e) - s.top,
                            i.add(X || S, "gu-transit"),
                            function() {
                                if (n)
                                    return;
                                var e = S.getBoundingClientRect();
                                (n = S.cloneNode(!0)).style.width = m(e) + "px",
                                n.style.height = p(e) + "px",
                                i.rm(n, "gu-transit"),
                                i.add(n, "gu-mirror"),
                                I.mirrorContainer.appendChild(n),
                                a(c, "add", "mousemove", W),
                                i.add(I.mirrorContainer, "gu-unselectable"),
                                M.emit("cloned", n, S, "mirror")
                            }(),
                            W(e)
                        }
                    } else
            ...
            function U(e) {
                ...
                t = e.item,
                n = e.source,
                ("boolean" == typeof I.copy ? I.copy : I.copy(t, n)) && (X = e.item.cloneNode(!0),
                M.emit("cloned", X, e.item, "copy")),
                b = e.source,
                S = e.item,
                N = O = y(e.item),
                M.dragging = !0,
            ...
            function H(e) {
                ...
                M.dragging) {
                    var t = X || S
                      ...
                      , o = E("clientY", e) || 0
                      , i = Q(v(n, r, o), r, o);
                    i && (X && I.copySortSource || !X || i !== b) ? V(t, i) : I.removeOnSpill ? $() : q()
                }
            }
            function V(e, t) {
                var n = g(e);
                X && I.copySortSource && t === b && n.removeChild(S),
                J(t) ? M.emit("cancel", e, b, b) : M.emit("drop", e, t, b, O),
                G()
            }
            function $() {
                if (M.dragging) {
            ...
            function q(e) {
                if (M.dragging) {
                    var t = arguments.length > 0 ? e : I.revertOnSpill
                      ...
                      , r = g(n)
                      , o = J(r);
                    !1 === o && t && (X ? r && r.removeChild(X) : b.insertBefore(n, N)),
                    o || t ? M.emit("cancel", n, b, b) : M.emit("drop", n, r, b, O),
                    G()
                }
            }
            function G() {
                var e = X || S;
                z(),
                n && (i.rm(I.mirrorContainer, "gu-unselectable"),
                a(c, "remove", "mousemove", W),
                g(n).removeChild(n),
                n = null),
                e && i.rm(e, "gu-transit"),
                Y && clearTimeout(Y),
            ...
            function Q(e, t, n) {
                ...
                function o() {
                    ...
                    var o = Z(r, e)
                      , i = ee(r, o, t, n);
                    return !!J(r, i) || I.accepts(S, r, b, i)
                }
            }
            function W(e) {
                if (n) {
                    ...
                    l && m("over"));
                    var f = g(u);
                    if (a !== b || !X || I.copySortSource) {
                        var s, d = Z(a, c);
                        if (null !== d)
                            s = ee(a, d, t, r);
                        else {
                            if (!0 !== I.revertOnSpill || X)
                                return void (X && f && f.removeChild(u));
                            s = N,
                            a = b
                        }
                        (null === s && l || s !== u && s !== y(u)) && (O = s,
                        a.insertBefore(u, s),
                        M.emit("shadow", u, a, b))
                    } else
                        f && f.removeChild(u)
            ...
            function Z(e, t) {
                for (var n = t; n !== e && g(n) !== e; )
                    n = g(n);
                return n === c ? null : n
            }
            function ee(e, t, n, r) {
                var o = "horizontal" === I.direction
                  , i = t !== e ? function() {
                    var e = t.getBoundingClientRect();
                    if (o)
                        return u(n > e.left + m(e) / 2);
                    return u(r > e.top + p(e) / 2)
                }() : function() {
                    var t, i, u, c = e.children.length;
                    for (t = 0; t < c; t++) {
                        if (u = (i = e.children[t]).getBoundingClientRect(),
                        o && u.left + u.width / 2 > n)
                            return i;
                        if (!o && u.top + u.height / 2 > r)
                            return i
                    }
                    return null
                }();
