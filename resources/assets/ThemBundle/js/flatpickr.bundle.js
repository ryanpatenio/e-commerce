"use strict";
(self.webpackChunkdashly = self.webpackChunkdashly || []).push([[694], {
    8527: (e, n, t) => {
        t.r(n),
        t.d(n, {
            default: () => Y
        ...
        function A(e, n) {
            ...
            function w() {
                ...
                !1 === e.weekNumbers && 1 === e.showMonths || !0 !== e.noCalendar && window.requestAnimationFrame((function() {
                    if (void 0 !== t.calendarContainer && (t.calendarContainer.style.visibility = "hidden",
                    ...
                    void 0 !== t.daysContainer) {
                        ...
                        t.calendarContainer.style.width = n + (void 0 !== t.weekWrapper ? t.weekWrapper.offsetWidth : 0) + "px",
            ...
            function C(e) {
                ...
                void 0 !== e && "blur" !== e.type && function(e) {
                    ...
                    if (void 0 !== i.value && 2 === i.value.length) {
                        var m = i === t.hourElement
                          , g = i === t.minuteElement;
                        f < o ? (f = r + f + c(!m) + (c(m) && c(!t.amPM)),
                        g && B(void 0, -1, t.hourElement)) : f > r && (f = i === t.hourElement ? f - r - c(!t.amPM) : o,
                        g && B(void 0, 1, t.hourElement)),
                        t.amPM && m && (1 === s ? f + d === 23 : Math.abs(f - d) > s) && (t.amPM.textContent = t.l10n.amPM[c(t.amPM.textContent === t.l10n.amPM[0])]),
                        i.value = l(f)
                    }
                }(e);
                ...
                A(),
                ke(),
                t._input.value !== i && t._debouncedChange()
            }
            function A() {
                if (void 0 !== t.hourElement && void 0 !== t.minuteElement) {
                    var e, n, a = (parseInt(t.hourElement.value.slice(-2), 10) || 0) % 24, i = (parseInt(t.minuteElement.value, 10) || 0) % 60, o = void 0 !== t.secondElement ? (parseInt(t.secondElement.value, 10) || 0) % 60 : 0;
                    void 0 !== t.amPM && (e = a,
                    n = t.amPM.textContent,
                    a = e % 12 + 12 * c(n === t.l10n.amPM[1]));
                    ...
                    if (void 0 !== t.config.maxTime && void 0 !== t.config.minTime && t.config.minTime > t.config.maxTime) {
                        var s = k(t.config.minTime.getHours(), t.config.minTime.getMinutes(), t.config.minTime.getSeconds())
                          , d = k(t.config.maxTime.getHours(), t.config.maxTime.getMinutes(), t.config.maxTime.getSeconds())
                          , u = k(a, i, o);
                        if (u > d && u < s) {
                            var f = T(s);
                            a = f[0],
            ...
            function N(e) {
                ...
                n && n instanceof Date && Y(n.getHours(), n.getMinutes(), n.getSeconds())
            }
            function Y(e, n, a) {
                void 0 !== t.latestSelectedDateObj && t.latestSelectedDateObj.setHours(e % 24, n, a || 0, 0),
                t.hourElement && t.minuteElement && !t.isMobile && (t.hourElement.value = l(t.config.time_24hr ? e : (12 + e) % 12 + 12 * c(e % 12 == 0)),
                t.minuteElement.value = l(n),
                void 0 !== t.amPM && (t.amPM.textContent = t.l10n.amPM[c(e >= 12)]),
                void 0 !== t.secondElement && (t.secondElement.value = l(a)))
            }
            function j(e) {
                var n = h(e)
                  , t = parseInt(n.value) + (e.delta || 0);
                (t / 1e3 > 1 || "Enter" === e.key && !/[^\d]/.test(t.toString())) && ae(t)
            }
            function H(e, n, a, i) {
            ...
            function R(e, n) {
                var a = void 0 !== e ? t.parseDate(e) : t.latestSelectedDateObj || (t.config.minDate && t.config.minDate > t.now ? t.config.minDate : t.config.maxDate && t.config.maxDate < t.now ? t.config.maxDate : t.now)
                  ...
                  , o = t.currentMonth;
                try {
                    void 0 !== a && (t.currentYear = a.getFullYear(),
                    t.currentMonth = a.getMonth())
                } catch (e) {
                    e.message = "Invalid date supplied: " + a,
                    t.config.errorHandler(e)
                }
                n && t.currentYear !== i && (Ce("onYearChange"),
                z()),
                !n || t.currentYear === i && t.currentMonth === o || Ce("onMonthChange"),
                t.redraw()
            }
            function W(e) {
                var n = h(e);
                ~n.className.indexOf("arrow") && B(e, n.classList.contains("arrowUp") ? 1 : -1)
            }
            function B(e, n, t) {
                var a = e && h(e)
            ...
            function J(e, n, a, i) {
                ...
                return r.dateObj = n,
                r.$i = i,
                r.setAttribute("aria-label", t.formatDate(n, t.config.ariaDateFormat)),
                -1 === e.indexOf("hidden") && 0 === x(n, t.now) && (t.todayDateElem = r,
                r.classList.add("today"),
                r.setAttribute("aria-current", "date")),
                o ? (r.tabIndex = -1,
                ye(n) && (r.classList.add("selected"),
                t.selectedDateElem = r,
                "range" === t.config.mode && (u(r, "startRange", t.selectedDates[0] && 0 === x(n, t.selectedDates[0], !0)),
                u(r, "endRange", t.selectedDates[1] && 0 === x(n, t.selectedDates[1], !0)),
                "nextMonthDay" === e && r.classList.add("inRange")))) : r.classList.add("flatpickr-disabled"),
                "range" === t.config.mode && function(e) {
                    return !("range" !== t.config.mode || t.selectedDates.length < 2) && (x(e, t.selectedDates[0]) >= 0 && x(e, t.selectedDates[1]) <= 0)
                }(n) && !ye(n) && r.classList.add("inRange"),
                t.weekNumbers && 1 === t.config.showMonths && "prevMonthDay" !== e && i % 7 == 6 && t.weekNumbers.insertAdjacentHTML("beforeend", "<span class='flatpickr-day'>" + t.config.getWeek(n) + "</span>"),
                Ce("onDayCreate", r),
                r
            }
            function K(e) {
                e.focus(),
                "range" === t.config.mode && ce(e)
            }
            function U(e) {
                for (var n = e > 0 ? 0 : t.config.showMonths - 1, a = e > 0 ? t.config.showMonths : -1, i = n; i != a; i += e)
                    for (var o = t.daysContainer.children[i], r = e > 0 ? 0 : o.children.length - 1, l = e > 0 ? o.children.length : -1, c = r; c != l; c += e) {
                        var s = o.children[c];
                        if (-1 === s.className.indexOf("hidden") && ie(s.dateObj))
                            return s
                    }
            }
            function q(e, n) {
                var a = o()
                  , i = oe(a || document.body)
                  , r = void 0 !== e ? e : i ? a : void 0 !== t.selectedDateElem && oe(t.selectedDateElem) ? t.selectedDateElem : void 0 !== t.todayDateElem && oe(t.todayDateElem) ? t.todayDateElem : U(n > 0 ? 1 : -1);
                void 0 === r ? t._input.focus() : i ? function(e, n) {
                    for (var a = -1 === e.className.indexOf("Month") ? e.dateObj.getMonth() : t.currentMonth, i = n > 0 ? t.config.showMonths : -1, o = n > 0 ? 1 : -1, r = a - t.currentMonth; r != i; r += o)
                        for (var l = t.daysContainer.children[r], c = a - t.currentMonth === r ? e.$i + n : n < 0 ? l.children.length - 1 : 0, s = l.children.length, d = c; d >= 0 && d < s && d != (n > 0 ? s : -1); d += o) {
                            var u = l.children[d];
                            if (-1 === u.className.indexOf("hidden") && ie(u.dateObj) && Math.abs(e.$i - d) >= Math.abs(n))
                                return K(u)
                        }
                    t.changeMonth(o),
                    q(U(o), 0)
            ...
            function $(e, n) {
                for (var a = (new Date(e,n,1).getDay() - t.l10n.firstDayOfWeek + 7) % 7, i = t.utils.getDaysInMonth((n - 1 + 12) % 12, e), o = t.utils.getDaysInMonth(n, e), r = window.document.createDocumentFragment(), l = t.config.showMonths > 1, c = l ? "prevMonthDay hidden" : "prevMonthDay", s = l ? "nextMonthDay hidden" : "nextMonthDay", d = i + 1 - a, u = 0; d <= i; d++,
                u++)
                    r.appendChild(J("flatpickr-day " + c, new Date(e,n - 1,d), 0, u));
                for (d = 1; d <= o; d++,
                u++)
                    r.appendChild(J("flatpickr-day", new Date(e,n,d), 0, u));
                for (var m = o + 1; m <= 42 - a && (1 === t.config.showMonths || u % 7 != 0); m++,
                u++)
                    r.appendChild(J("flatpickr-day " + s, new Date(e,n + 1,m % o), 0, u));
                var g = f("div", "dayContainer");
                return g.appendChild(r),
                g
            }
            function V() {
                if (void 0 !== t.daysContainer) {
                    m(t.daysContainer),
                    t.weekNumbers && m(t.weekNumbers);
                    for (var e = document.createDocumentFragment(), n = 0; n < t.config.showMonths; n++) {
                        ...
                        e.appendChild($(a.getFullYear(), a.getMonth()))
                    }
                    t.daysContainer.appendChild(e),
                    t.days = t.daysContainer.firstChild,
                    "range" === t.config.mode && 1 === t.selectedDates.length && ce()
                }
            }
            function z() {
                if (!(t.config.showMonths > 1 || "dropdown" !== t.config.monthSelectorType)) {
                    ...
                    for (var n = 0; n < 12; n++)
                        if (e(n)) {
                            ...
                            a.textContent = D(n, t.config.shorthandCurrentMonth, t.l10n),
                            a.tabIndex = -1,
            ...
            function G() {
                var e, n = f("div", "flatpickr-month"), a = window.document.createDocumentFragment();
                t.config.showMonths > 1 || "static" === t.config.monthSelectorType ? e = f("span", "cur-month") : (t.monthsDropdownContainer = f("select", "flatpickr-monthDropdown-months"),
                t.monthsDropdownContainer.setAttribute("aria-label", t.l10n.monthAriaLabel),
                H(t.monthsDropdownContainer, "change", (function(e) {
                    var n = h(e)
                      , a = parseInt(n.value, 10);
                    t.changeMonth(a - t.currentMonth),
                    Ce("onMonthChange")
                }
                )),
                z(),
                ...
                t.config.minDate && o.setAttribute("min", t.config.minDate.getFullYear().toString()),
                t.config.maxDate && (o.setAttribute("max", t.config.maxDate.getFullYear().toString()),
                o.disabled = !!t.config.minDate && t.config.minDate.getFullYear() === t.config.maxDate.getFullYear());
            ...
            function X() {
                if (t.weekdayContainer) {
                    var e = t.l10n.firstDayOfWeek
                      , n = O(t.l10n.weekdays.shorthand);
                    e > 0 && e < n.length && (n = O(n.splice(e, n.length), n.splice(0, e)));
            ...
            function ee(e, n) {
                ...
                a < 0 && !0 === t._hidePrevMonthArrow || a > 0 && !0 === t._hideNextMonthArrow || (t.currentMonth += a,
            ...
            function te(e) {
                if (t.isOpen && !t.config.inline) {
                    var n = h(e)
                      , a = ne(n)
                      , i = !(n === t.input || n === t.altInput || t.element.contains(n) || e.path && e.path.indexOf && (~e.path.indexOf(t.input) || ~e.path.indexOf(t.altInput))) && !a && !ne(e.relatedTarget)
                    ...
                    void 0 !== t.timeContainer && void 0 !== t.minuteElement && void 0 !== t.hourElement && "" !== t.input.value && void 0 !== t.input.value && C(),
                    t.close(),
                    t.config && "range" === t.config.mode && 1 === t.selectedDates.length && t.clear(!1))
                }
            }
            function ae(e) {
            ...
            function ie(e, n) {
                ...
                if (t.config.minDate && i && x(i, t.config.minDate, void 0 !== n ? n : !t.minDateHasTime) < 0 || t.config.maxDate && i && x(i, t.config.maxDate, void 0 !== n ? n : !t.maxDateHasTime) > 0)
                    return !1;
                if (!t.config.enable && 0 === t.config.disable.length)
                    return !0;
                if (void 0 === i)
                    return !1;
            ...
            function re(e) {
                var n = e.target === t._input
                  , a = t._input.value.trimEnd() !== Ee();
                !n || !a || e.relatedTarget && ne(e.relatedTarget) || t.setDate(t._input.value, !0, e.target === t.altInput ? t.config.altFormat : t.config.dateFormat)
            }
            function le(n) {
                var a = h(n)
                ...
                if (13 === n.keyCode && i) {
                    if (r)
                        return t.setDate(t._input.value, !0, a === t.altInput ? t.config.altFormat : t.config.dateFormat),
                        t.close(),
                        a.blur();
                    t.open()
                } else if (ne(a) || l || c) {
                    ...
                    case 8:
                    case 46:
                        i && !t.config.allowInput && (n.preventDefault(),
                        t.clear());
                        break;
                    case 37:
                    case 39:
                        if (s || i)
                            ...
                            n.preventDefault();
                            var d = o();
                            if (void 0 !== t.daysContainer && (!1 === r || d && oe(d))) {
                    ...
                    case 40:
                        ...
                        t.daysContainer && void 0 !== a.$i || a === t.input || a === t.altInput ? n.ctrlKey ? (n.stopPropagation(),
                        ae(t.currentYear - f),
                        q(U(1), 0)) : s || q(void 0, 7 * f) : a === t.currentYearElement ? ae(t.currentYear - f) : t.config.enableTime && (!s && t.hourElement && t.hourElement.focus(),
                        C(n),
                        t._debouncedChange());
                        break;
                    case 9:
                        if (s) {
                            ...
                            !t.config.noCalendar && t.daysContainer && t.daysContainer.contains(a) && n.shiftKey && (n.preventDefault(),
                            t._input.focus())
                    }
                }
                ...
                (i || ne(a)) && Ce("onKeyDown", n)
            }
            function ce(e, n) {
                if (void 0 === n && (n = "flatpickr-day"),
                1 === t.selectedDates.length && (!e || e.classList.contains(n) && !e.classList.contains("flatpickr-disabled"))) {
                    for (var a = e ? e.dateObj.getTime() : t.days.firstElementChild.dateObj.getTime(), i = t.parseDate(t.selectedDates[0], void 0, !0).getTime(), o = Math.min(a, t.selectedDates[0].getTime()), r = Math.max(a, t.selectedDates[0].getTime()), l = !1, c = 0, s = 0, d = o; d < r; d += I.DAY)
                        ie(new Date(d), !0) || (l = l || d > o && d < r,
                        d < i && (!c || d > c) ? c = d : d > i && (!s || d < s) && (s = d));
                    Array.from(t.rContainer.querySelectorAll("*:nth-child(-n+" + t.config.showMonths + ") > ." + n)).forEach((function(n) {
                        var o = n.dateObj.getTime()
                          , r = c > 0 && o < c || s > 0 && o > s;
                        if (r)
                        ...
                        void 0 !== e && (e.classList.add(a <= t.selectedDates[0].getTime() ? "startRange" : "endRange"),
                        i < a && o === i ? n.classList.add("startRange") : i > a && o === i && n.classList.add("endRange"),
                        o >= c && (0 === s || o <= s) && E(o, i, a) && n.classList.add("inRange")))
                    }
                    ))
                }
            }
            function se() {
                !t.isOpen || t.config.static || t.config.inline || me()
            }
            function de(e) {
                return function(n) {
                    var a = t.config["_" + e + "Date"] = t.parseDate(n, t.config.dateFormat)
                      , i = t.config["_" + ("min" === e ? "max" : "min") + "Date"];
                    void 0 !== a && (t["min" === e ? "minDateHasTime" : "maxDateHasTime"] = a.getHours() > 0 || a.getMinutes() > 0 || a.getSeconds() > 0),
                    t.selectedDates && (t.selectedDates = t.selectedDates.filter((function(e) {
                        return ie(e)
                    }
                    )),
                    t.selectedDates.length || "min" !== e || N(a),
                    ke()),
                    t.daysContainer && (ge(),
                    void 0 !== a ? t.currentYearElement[e] = a.getFullYear().toString() : t.currentYearElement.removeAttribute(e),
                    t.currentYearElement.disabled = !!i && void 0 !== a && i.getFullYear() === a.getFullYear())
                }
            }
            function ue() {
            ...
            function fe() {
                "object" != typeof t.config.locale && void 0 === P.l10ns[t.config.locale] && t.config.errorHandler(new Error("flatpickr: invalid locale " + t.config.locale)),
                t.l10n = _(_({}, P.l10ns.default), "object" == typeof t.config.locale ? t.config.locale : "default" !== t.config.locale ? P.l10ns[t.config.locale] : void 0),
                ...
                b.K = "(" + t.l10n.amPM[0] + "|" + t.l10n.amPM[1] + "|" + t.l10n.amPM[0].toLowerCase() + "|" + t.l10n.amPM[1].toLowerCase() + ")",
                void 0 === _(_({}, n), JSON.parse(JSON.stringify(e.dataset || {}))).time_24hr && void 0 === P.defaultConfig.time_24hr && (t.config.time_24hr = t.l10n.time_24hr),
                t.formatDate = M(t),
                t.parseDate = y({
                    config: t.config,
                    l10n: t.l10n
            ...
            function me(e) {
                if ("function" != typeof t.config.position) {
                    if (void 0 !== t.calendarContainer) {
                        ...
                        if (u(t.calendarContainer, "arrowTop", !d),
                        u(t.calendarContainer, "arrowBottom", d),
                        !t.config.inline) {
                            var m = window.pageXOffset + c.left
                              , g = !1
                              , p = !1;
                            "center" === l ? (m -= (i - c.width) / 2,
                            g = !0) : "right" === l && (m -= i - c.width,
                            p = !0),
                            u(t.calendarContainer, "arrowLeft", !g && !p),
                            u(t.calendarContainer, "arrowCenter", g),
                            u(t.calendarContainer, "arrowRight", p);
                            ...
                            if (u(t.calendarContainer, "rightMost", v),
                            !t.config.static)
                                if (t.calendarContainer.style.top = f + "px",
                                v)
                                    if (D) {
                                        var w = function() {
                                        ...
                                        u(t.calendarContainer, "rightMost", !1),
                                        u(t.calendarContainer, "centerMost", !0),
                                        ...
                                        t.calendarContainer.style.right = h + "px";
                                else
                                    t.calendarContainer.style.left = m + "px",
                                    t.calendarContainer.style.right = "auto"
                        }
                    }
                } else
                    t.config.position(t, e)
            }
            function ge() {
                t.config.noCalendar || t.isMobile || (z(),
                xe(),
                V())
            }
            function pe() {
                t._input.focus(),
                -1 !== window.navigator.userAgent.indexOf("MSIE") || void 0 !== navigator.msMaxTouchPoints ? setTimeout(t.close, 0) : t.close()
            }
            function he(e) {
                e.preventDefault(),
                e.stopPropagation();
                ...
                if (void 0 !== n) {
                    ...
                    "single" === t.config.mode)
                        ...
                        "range" === t.config.mode && (2 === t.selectedDates.length && t.clear(!1, !1),
                        t.latestSelectedDateObj = i,
                        t.selectedDates.push(i),
                        0 !== x(i, t.selectedDates[0], !0) && t.selectedDates.sort((function(e, n) {
                    ...
                    o) {
                        ...
                        t.currentYear = i.getFullYear(),
                        t.currentMonth = i.getMonth(),
                        l && (Ce("onYearChange"),
                        z()),
                        Ce("onMonthChange")
                    }
                    ...
                    V(),
                    ke(),
                    o || "range" === t.config.mode || 1 !== t.config.showMonths ? void 0 !== t.selectedDateElem && void 0 === t.hourElement && t.selectedDateElem && t.selectedDateElem.focus() : K(a),
                    void 0 !== t.hourElement && void 0 !== t.hourElement && t.hourElement.focus(),
            ...
            t.loadedPlugins = [],
            t._bind = H,
            t._setHoursFromDate = N,
            t._positionCalendar = me,
            t.changeMonth = ee,
            t.changeYear = ae,
            t.clear = function(e, n) {
                ...
                !0 === n && (t.currentYear = t._initialDate.getFullYear(),
                t.currentMonth = t._initialDate.getMonth());
                if (!0 === t.config.enableTime) {
                    var a = S(t.config);
                    Y(a.hours, a.minutes, a.seconds)
                }
                t.redraw(),
                e && Ce("onChange")
            }
            ...
            t.close = function() {
                t.isOpen = !1,
                t.isMobile || (void 0 !== t.calendarContainer && t.calendarContainer.classList.remove("open"),
            ...
            t.createDay = J,
            t.destroy = function() {
                void 0 !== t.config && Ce("onDestroy");
                for (var e = t._handlers.length; e--; )
                    t._handlers[e].remove();
                if (t._handlers = [],
                t.mobileInput)
            ...
            t.open = function(e, n) {
                ...
                if (!0 === t.isMobile) {
                    ...
                    return void 0 !== t.mobileInput && (t.mobileInput.focus(),
                    t.mobileInput.click()),
                    void Ce("onOpen")
                }
                ...
                var i = t.isOpen;
                t.isOpen = !0,
                i || (t.calendarContainer.classList.add("open"),
            ...
            t.set = function(e, n) {
                if (null !== e && "object" == typeof e)
                    for (var i in Object.assign(t.config, e),
                    e)
                        void 0 !== ve[i] && ve[i].forEach((function(e) {
                            return e()
                        }
                        ));
                else
            ...
            var ve = {
                ...
                positionElement: [be],
                clickOpens: [function() {
                    !0 === t.config.clickOpens ? (H(t._input, "focus", t.open),
                    H(t._input, "click", t.open)) : (t._input.removeEventListener("focus", t.open),
            ...
            function De(e, n) {
                ...
                if (e instanceof Array)
                    ...
                    t.config.errorHandler(new Error("Invalid date supplied: " + JSON.stringify(e)));
                ...
                if (void 0 !== t.config) {
                    ...
                    if (void 0 !== a && a.length > 0)
                        for (var i = 0; a[i] && i < a.length; i++)
                            a[i](t.selectedDates, t.input.value, t, n);
                    "onChange" === e && (t.input.dispatchEvent(Me("change")),
                    t.input.dispatchEvent(Me("input")))
                }
            }
            function Me(e) {
            ...
            function xe() {
                t.config.noCalendar || t.isMobile || !t.monthNav || (t.yearElements.forEach((function(e, n) {
                    var a = new Date(t.currentYear,t.currentMonth,1);
                    a.setMonth(t.currentMonth + n),
                    t.config.showMonths > 1 || "static" === t.config.monthSelectorType ? t.monthElements[n].textContent = D(a.getMonth(), t.config.shorthandCurrentMonth, t.l10n) + " " : t.monthsDropdownContainer.value = a.getMonth().toString(),
                    e.value = a.getFullYear().toString()
                }
                )),
                t._hidePrevMonthArrow = void 0 !== t.config.minDate && (t.currentYear === t.config.minDate.getFullYear() ? t.currentMonth <= t.config.minDate.getMonth() : t.currentYear < t.config.minDate.getFullYear()),
                t._hideNextMonthArrow = void 0 !== t.config.maxDate && (t.currentYear === t.config.maxDate.getFullYear() ? t.currentMonth + 1 > t.config.maxDate.getMonth() : t.currentYear > t.config.maxDate.getFullYear()))
            }
            function Ee(e) {
            ...
            function ke(e) {
                void 0 === e && (e = !0),
                void 0 !== t.mobileInput && t.mobileFormatStr && (t.mobileInput.value = void 0 !== t.latestSelectedDateObj ? t.formatDate(t.latestSelectedDateObj, t.mobileFormatStr) : ""),
                t.input.value = Ee(t.config.dateFormat),
                void 0 !== t.altInput && (t.altInput.value = Ee(t.config.altFormat)),
                !1 !== e && Ce("onValueUpdate")
            }
            function Te(e) {
                var n = h(e)
                  , a = t.prevMonthNav.contains(n)
                  , i = t.nextMonthNav.contains(n);
                a || i ? ee(a ? -1 : 1) : t.yearElements.indexOf(n) >= 0 ? n.select() : n.classList.contains("arrowUp") ? t.changeYear(t.currentYear + 1) : n.classList.contains("arrowDown") && t.changeYear(t.currentYear - 1)
            }
            return function() {
                t.element = t.input = e,
                t.isOpen = !1,
                function() {
                    var o = ["wrap", "weekNumbers", "allowInput", "allowInvalidPreload", "clickOpens", "time_24hr", "enableTime", "noCalendar", "altInput", "shorthandCurrentMonth", "inline", "static", "enableSeconds", "disableMobile"]
                      , r = _(_({}, JSON.parse(JSON.stringify(e.dataset || {}))), n)
                      , l = {};
                    t.config.parseDate = r.parseDate,
                    t.config.formatDate = r.formatDate,
                    Object.defineProperty(t.config, "enable", {
                        get: function() {
                            return t.config._enable
                        },
                        set: function(e) {
                            t.config._enable = we(e)
                        }
                    }),
                    ...
                    "time" === r.mode && (t.config.noCalendar = !0,
                    t.config.enableTime = !0);
                    Object.assign(t.config, l, r);
                    for (var m = 0; m < o.length; m++)
                        t.config[o[m]] = !0 === t.config[o[m]] || "true" === t.config[o[m]];
                    a.filter((function(e) {
                    ...
                    for (m = 0; m < t.config.plugins.length; m++) {
                        ...
                        for (var p in g)
                            a.indexOf(p) > -1 ? t.config[p] = d(g[p]).map(v).concat(t.config[p]) : void 0 === r[p] && (t.config[p] = g[p])
                    }
                    r.altInputClass || (t.config.altInputClass = ue().className + " " + t.config.altInputClass);
                    Ce("onParseConfig")
                }(),
                fe(),
                function() {
                    if (t.input = ue(),
                    !t.input)
                        return void t.config.errorHandler(new Error("Invalid input element specified"));
                    t.input._type = t.input.type,
                    t.input.type = "text",
                    t.input.classList.add("flatpickr-input"),
                    t._input = t.input,
                    t.config.altInput && (t.altInput = f(t.input.nodeName, t.config.altInputClass),
                    t._input = t.altInput,
                ...
                t.utils = {
                    getDaysInMonth: function(e, n) {
                        return void 0 === e && (e = t.currentMonth),
                        void 0 === n && (n = t.currentYear),
                        1 === e && (n % 4 == 0 && n % 100 != 0 || n % 400 == 0) ? 29 : t.l10n.daysInMonth[e]
                    }
                },
                t.isMobile || function() {
                    var e = window.document.createDocumentFragment();
                    if (t.calendarContainer = f("div", "flatpickr-calendar"),
                    t.calendarContainer.tabIndex = -1,
                    !t.config.noCalendar) {
                        if (e.appendChild((t.monthNav = f("div", "flatpickr-months"),
                        t.yearElements = [],
                        t.monthElements = [],
                        ...
                        Object.defineProperty(t, "_hidePrevMonthArrow", {
                            ...
                            set: function(e) {
                                t.__hidePrevMonthArrow !== e && (u(t.prevMonthNav, "flatpickr-disabled", e),
                        ...
                        Object.defineProperty(t, "_hideNextMonthArrow", {
                            ...
                            set: function(e) {
                                t.__hideNextMonthArrow !== e && (u(t.nextMonthNav, "flatpickr-disabled", e),
                        ...
                        t.daysContainer || (t.daysContainer = f("div", "flatpickr-days"),
                    ...
                    t.config.enableTime && e.appendChild(function() {
                        ...
                        t.hourElement.value = l(t.latestSelectedDateObj ? t.latestSelectedDateObj.getHours() : t.config.time_24hr ? e.hours : function(e) {
                            switch (e % 24) {
                            case 0:
                            case 12:
                                return 12;
                        ...
                        t.minuteElement.value = l(t.latestSelectedDateObj ? t.latestSelectedDateObj.getMinutes() : e.minutes),
                        ...
                        if (t.config.enableSeconds) {
                            ...
                            t.secondElement = o.getElementsByTagName("input")[0],
                            t.secondElement.value = l(t.latestSelectedDateObj ? t.latestSelectedDateObj.getSeconds() : e.seconds),
                            ...
                            t.timeContainer.appendChild(f("span", "flatpickr-time-separator", ":")),
                            t.timeContainer.appendChild(o)
                        }
                        t.config.time_24hr || (t.amPM = f("span", "flatpickr-am-pm", t.l10n.amPM[c((t.latestSelectedDateObj ? t.hourElement.value : t.config.defaultHour) > 11)]),
                        t.amPM.title = t.l10n.toggleTitle,
                        t.amPM.tabIndex = -1,
                        t.timeContainer.appendChild(t.amPM));
                        return t.timeContainer
                    }());
                    u(t.calendarContainer, "rangeMode", "range" === t.config.mode),
                    u(t.calendarContainer, "animate", !0 === t.config.animate),
                    u(t.calendarContainer, "multiMonth", t.config.showMonths > 1),
                    ...
                    t.config.inline && (!o && t.element.parentNode ? t.element.parentNode.insertBefore(t.calendarContainer, t._input.nextSibling) : void 0 !== t.config.appendTo && t.config.appendTo.appendChild(t.calendarContainer)),
                    t.config.static)) {
                        var r = f("div", "flatpickr-wrapper");
                        t.element.parentNode && t.element.parentNode.insertBefore(r, t.element),
                        r.appendChild(t.element),
                        t.altInput && r.appendChild(t.altInput),
                        r.appendChild(t.calendarContainer)
                    }
                ...
                function() {
                    ...
                    if (t.isMobile)
                        return void function() {
                            ...
                            t.mobileInput = f("input", t.input.className + " flatpickr-mobile"),
                            ...
                            t.mobileFormatStr = "datetime-local" === e ? "Y-m-d\\TH:i:S" : "date" === e ? "Y-m-d" : "H:i:S",
                            ...
                            H(t.mobileInput, "change", (function(e) {
                                t.setDate(h(e).value, !1, t.mobileFormatStr),
                                Ce("onChange"),
                                Ce("onClose")
                            }
                            ))
                    ...
                    var e = s(se, 50);
                    t._debouncedChange = s(L, F),
                    t.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent) && H(t.daysContainer, "mouseover", (function(e) {
                        "range" === t.config.mode && ce(h(e))
                    }
                    ));
                    H(t._input, "keydown", le),
                    void 0 !== t.calendarContainer && H(t.calendarContainer, "keydown", le);
                    t.config.inline || t.config.static || H(window, "resize", e);
                    void 0 !== window.ontouchstart ? H(window.document, "touchstart", te) : H(window.document, "mousedown", te);
                    H(window.document, "focus", te, {
                        capture: !0
                    }),
                    !0 === t.config.clickOpens && (H(t._input, "focus", t.open),
                    H(t._input, "click", t.open));
                    void 0 !== t.daysContainer && (H(t.monthNav, "click", Te),
                    H(t.monthNav, ["keyup", "increment"], j),
                    H(t.daysContainer, "click", he));
                    if (void 0 !== t.timeContainer && void 0 !== t.minuteElement && void 0 !== t.hourElement) {
                        var n = function(e) {
                            return h(e).select()
                        };
                        H(t.timeContainer, ["increment"], C),
                        H(t.timeContainer, "blur", C, {
                            capture: !0
                        }),
                        H(t.timeContainer, "click", W),
                        H([t.hourElement, t.minuteElement], ["focus", "click"], n),
                        void 0 !== t.secondElement && H(t.secondElement, "focus", (function() {
                            return t.secondElement && t.secondElement.select()
                        }
                        )),
                        void 0 !== t.amPM && H(t.amPM, "click", (function(e) {
                            C(e)
                        }
                        ))
                    }
                    t.config.allowInput && H(t._input, "blur", re)
                }(),
                (t.selectedDates.length || t.config.noCalendar) && (t.config.enableTime && N(t.config.noCalendar ? t.latestSelectedDateObj : void 0),
                ke(!1)),
                w();
        ...
        var P = function(e, n) {
            return "string" == typeof e ? N(window.document.querySelectorAll(e), n) : e instanceof Node ? N([e], n) : N(e, n)
        };
        P.defaultConfig = {},
        P.l10ns = {
            en: _({}, r),
        ...
        P.localize = function(e) {
            P.l10ns.default = _(_({}, P.l10ns.default), e)
        }
        ,
        P.setDefaults = function(e) {
            P.defaultConfig = _(_({}, P.defaultConfig), e)
        }
        ,
        P.parseDate = y({}),
        P.formatDate = M({}),
