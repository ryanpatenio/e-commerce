"use strict";
(self.webpackChunkdashly = self.webpackChunkdashly || []).push([[840, 416], {
    6921: (e, t, o) => {
        o.r(t),
        o.d(t, {
            PopupPickerController: () => se,
            createPopup: () => ae
        });
        var i = o(7741);
        function s(e) {
        ...
        function n(e) {
            return ["top", "bottom"].includes(s(e)) ? "x" : "y"
        }
        function a(e) {
            return "y" === e ? "height" : "width"
        }
        function c(e, t, o) {
            let {reference: i, floating: c} = e;
            const l = i.x + i.width / 2 - c.width / 2
              , h = i.y + i.height / 2 - c.height / 2
              , d = n(t)
              , m = a(d)
              , u = i[m] / 2 - c[m] / 2
              , p = "x" === d;
        ...
        async function h(e, t) {
            var o;
            void 0 === t && (t = {});
            const {x: i, y: s, platform: r, rects: n, elements: a, strategy: c} = e
              , {boundary: h="clippingAncestors", rootBoundary: d="viewport", elementContext: m="floating", altBoundary: u=!1, padding: p=0} = t
              , g = function(e) {
              ...
              , y = a[u ? "floating" === m ? "reference" : "floating" : m]
              , f = l(await r.getClippingRect({
                element: null == (o = await (null == r.isElement ? void 0 : r.isElement(y))) || o ? y : y.contextElement || await (null == r.getDocumentElement ? void 0 : r.getDocumentElement(a.floating)),
                boundary: h,
                rootBoundary: d,
                strategy: c
            }))
              , v = l(r.convertOffsetParentRelativeRectToViewportRelativeRect ? await r.convertOffsetParentRelativeRectToViewportRelativeRect({
                rect: "floating" === m ? {
                    ...n.floating,
                    x: i,
                    y: s
            ...
            return {
                top: f.top - v.top + g.top,
                bottom: v.bottom - f.bottom + g.bottom,
                left: f.left - v.left + g.left,
                right: v.right - f.right + g.right
            }
        }
        const d = Math.min
          , m = Math.max;
        ...
        function y(e, t, o) {
            ...
            const i = r(e)
              , s = n(e)
              , c = a(s);
            let l = "x" === s ? i === (o ? "end" : "start") ? "right" : "left" : "start" === i ? "bottom" : "top";
            return t.reference[c] > t.floating[c] && (l = g(l)),
            {
                main: l,
                cross: g(l)
            }
        ...
        const w = ["top", "right", "bottom", "left"].reduce(( (e, t) => e.concat(t, t + "-start", t + "-end")), []);
        const b = function(e) {
            return void 0 === e && (e = {}),
            {
                name: "autoPlacement",
                ...
                async fn(t) {
                    var o, i, n, a, c;
                    const {x: l, y: d, rects: m, middlewareData: u, placement: p, platform: g, elements: f} = t
                      , {alignment: b=null, allowedPlacements: C=w, autoAlignment: j=!0, ...k} = e
                      , _ = function(e, t, o) {
                        return (e ? [...o.filter((t => r(t) === e)), ...o.filter((t => r(t) !== e))] : o.filter((e => s(e) === e))).filter((o => !e || r(o) === e || !!t && v(o) !== o))
                    }(b, j, C)
                      , x = await h(t, k)
                      , E = null != (o = null == (i = u.autoPlacement) ? void 0 : i.index) ? o : 0
                      , S = _[E];
                    if (null == S)
                        return {};
                    const {main: L, cross: P} = y(S, m, await (null == g.isRTL ? void 0 : g.isRTL(f.floating)));
                    if (p !== S)
                        return {
                            x: l,
                            y: d,
                    ...
                    const z = [x[s(S)], x[L], x[P]]
                      , F = [...null != (n = null == (a = u.autoPlacement) ? void 0 : a.overflows) ? n : [], {
                        placement: S,
                        overflows: z
                    }]
                      , A = _[E + 1];
                    ...
                    const $ = F.slice().sort(( (e, t) => e.overflows[0] - t.overflows[0]))
                      , R = null == (c = $.find((e => {
                        let {overflows: t} = e;
                        return t.every((e => e <= 0))
                    }
                    ))) ? void 0 : c.placement
                      , T = null != R ? R : $[0].placement;
                    return T !== p ? {
                        data: {
                            index: E + 1,
                            overflows: F
        ...
        const C = function(e) {
            return void 0 === e && (e = {}),
            {
                ...
                async fn(t) {
                    var o;
                    const {placement: i, middlewareData: r, rects: n, initialPlacement: a, platform: c, elements: l} = t
                      , {mainAxis: d=!0, crossAxis: m=!0, fallbackPlacements: u, fallbackStrategy: p="bestFit", flipAlignment: f=!0, ...w} = e
                      , b = s(i)
                      , C = u || (b !== a && f ? function(e) {
                        const t = g(e);
                        return [v(e), t, v(t)]
                    }(a) : [g(a)])
                      , j = [a, ...C]
                      , k = await h(t, w)
                      , _ = [];
                    let x = (null == (o = r.flip) ? void 0 : o.overflows) || [];
                    if (d && _.push(k[b]),
                    m) {
                        const {main: e, cross: t} = y(i, n, await (null == c.isRTL ? void 0 : c.isRTL(l.floating)));
                        _.push(k[e], k[t])
                    }
                    if (x = [...x, {
                        placement: i,
                    ...
                    !_.every((e => e <= 0))) {
                        var E, S;
                        const e = (null != (E = null == (S = r.flip) ? void 0 : S.index) ? E : 0) + 1
                          , t = j[e];
                        if (t)
                            return {
                                data: {
                        ...
                        case "bestFit":
                            {
                                var L;
                                const e = null == (L = x.map((e => [e, e.overflows.filter((e => e > 0)).reduce(( (e, t) => e + t), 0)])).sort(( (e, t) => e[1] - t[1]))[0]) ? void 0 : L[0].placement;
                                e && (o = e);
                                break
                            }
                    ...
                    const {x: o, y: i} = t
                      , a = await async function(e, t) {
                        const {placement: o, platform: i, elements: a} = e
                          , c = await (null == i.isRTL ? void 0 : i.isRTL(a.floating))
                          , l = s(o)
                          , h = r(o)
                          , d = "x" === n(o)
                          , m = ["left", "top"].includes(l) ? -1 : 1
                          , u = c && d ? -1 : 1
                          , p = "function" == typeof t ? t(e) : t;
                        let {mainAxis: g, crossAxis: y, alignmentAxis: f} = "number" == typeof p ? {
                            mainAxis: p,
                            crossAxis: 0,
                            alignmentAxis: null
                        } : {
                        ...
                        return h && "number" == typeof f && (y = "end" === h ? -1 * f : f),
                        d ? {
                            x: y * u,
                            y: g * m
                        } : {
        ...
        const k = function(e) {
            return void 0 === e && (e = {}),
            {
                ...
                options: e,
                async fn(t) {
                    const {x: o, y: i, placement: r} = t
                      , {mainAxis: a=!0, crossAxis: c=!1, limiter: l={
                        fn: e => {
                            let {x: t, y: o} = e;
                            return {
                                x: t,
                    ...
                    if (a) {
                        ...
                        f = u(f + p["y" === g ? "top" : "left"], f, f - p[e])
                    }
                    if (c) {
                        const e = "y" === y ? "bottom" : "right";
                        v = u(v + p["y" === y ? "top" : "left"], v, v - p[e])
                    }
                    const w = l.fn({
                        ...t,
                        [g]: f,
        ...
        function S(e) {
            return _(e) ? "" : e ? (e.nodeName || "").toLowerCase() : ""
        }
        function L() {
        ...
        function F(e) {
            if (typeof ShadowRoot > "u")
                return !1;
            return e instanceof x(e).ShadowRoot || e instanceof ShadowRoot
        }
        function A(e) {
            const {overflow: t, overflowX: o, overflowY: i} = E(e);
        ...
        function V(e, t, o) {
            ...
            let c = 1
              , l = 1;
            t && P(e) && (c = e.offsetWidth > 0 && M(a.width) / e.offsetWidth || 1,
            l = e.offsetHeight > 0 && M(a.height) / e.offsetHeight || 1);
            const h = z(e) ? x(e) : window
              , d = !T() && o
              , m = (a.left + (d && null != (i = null == (s = h.visualViewport) ? void 0 : s.offsetLeft) ? i : 0)) / c
              , u = (a.top + (d && null != (r = null == (n = h.visualViewport) ? void 0 : n.offsetTop) ? r : 0)) / l
              , p = a.width / c
              , g = a.height / l;
            return {
                width: p,
        ...
        function D(e) {
            ...
            }(e) ? e.ownerDocument : e.document) || window.document).documentElement
        }
        function O(e) {
            return z(e) ? {
        ...
        function N(e) {
            return V(D(e)).left + O(e).scrollLeft
        }
        function H(e, t, o) {
            const i = P(t)
              , s = D(t)
            ...
            if (i || !i && "fixed" !== o)
                ...
                P(t)) {
                    ...
                    s && (a.x = N(s));
            return {
                x: r.left + n.scrollLeft - a.x,
                y: r.top + n.scrollTop - a.y,
                width: r.width,
                height: r.height
            }
        }
        function K(e) {
            return "html" === S(e) ? e : e.assignedSlot || e.parentNode || (F(e) ? e.host : null) || D(e)
        }
        function W(e) {
            return P(e) && "fixed" !== E(e).position ? function(e) {
                let {offsetParent: t} = e
                  , o = e
                  , i = !1;
                for (; o && o !== t; ) {
                    const {assignedSlot: e} = o;
                    if (e) {
                        let s = e.offsetParent;
                        if ("contents" === E(e).display) {
                            const t = e.hasAttribute("style")
                              , i = e.style.display;
                            e.style.display = E(o).display,
                            s = e.offsetParent,
                            e.style.display = i,
                        ...
                        t !== s && (t = s,
                        i = !0)
                    } else if (F(o) && o.host && i)
                        break;
                    o = F(o) && o.host || o.parentNode
                }
                return t
            }(e) : null
        }
        function U(e) {
            const t = x(e);
            let o = W(e);
            for (; o && $(o) && "static" === E(o).position; )
                o = W(o);
            return o && ("html" === S(o) || "body" === S(o) && "static" === E(o).position && !R(o)) ? t : o || function(e) {
                let t = K(e);
                for (F(t) && (t = t.host); P(t) && !["html", "body"].includes(S(t)); ) {
                    if (R(t))
                        return t;
                    {
        ...
        function G(e) {
            const t = K(e);
            return ["html", "body", "#document"].includes(S(t)) ? e.ownerDocument.body : P(t) && A(t) ? t : G(t)
        }
        function Z(e, t) {
            var o;
            void 0 === t && (t = []);
            const i = G(e)
              , s = i === (null == (o = e.ownerDocument) ? void 0 : o.body)
              , r = x(i)
              , n = s ? [r].concat(r.visualViewport || [], A(i) ? i : []) : i
              , a = t.concat(n);
            return s ? a : a.concat(Z(n))
        }
        function J(e, t, o) {
            return "viewport" === t ? l(function(e, t) {
            ...
            }(e, o)) : z(t) ? function(e, t) {
                const o = V(e, !1, "fixed" === t)
                  , i = o.top + e.clientTop
                ...
                const o = D(e)
                  ...
                  , r = B(o.scrollWidth, o.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0)
                  , n = B(o.scrollHeight, o.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0);
                let a = -i.scrollLeft + N(e);
                const c = -i.scrollTop;
                return "rtl" === E(s || o).direction && (a += B(o.clientWidth, s ? s.clientWidth : 0) - r),
                {
                    width: r,
                    height: n,
                    x: a,
        ...
        function Y(e) {
            const t = Z(e)
              , o = ["absolute", "fixed"].includes(E(e).position) && P(e) ? U(e) : e;
            return z(o) ? t.filter((e => z(e) && function(e, t) {
                const o = null == t.getRootNode ? void 0 : t.getRootNode();
                if (e.contains(t))
                    return !0;
                if (o && F(o)) {
                    let o = t;
        ...
        const X = {
            getClippingRect: function(e) {
                ...
                const r = [..."clippingAncestors" === o ? Y(t) : [].concat(o), i]
                  , n = r[0]
                  , a = r.reduce(( (e, o) => {
                    const i = J(t, o, s);
                    return e.top = B(i.top, e.top),
                    e.right = I(i.right, e.right),
                    e.bottom = I(i.bottom, e.bottom),
            ...
            convertOffsetParentRelativeRectToViewportRelativeRect: function(e) {
                ...
                if ((s || !s && "fixed" !== i) && (("body" !== S(o) || A(r)) && (n = O(o)),
                P(o))) {
                    const e = V(o, !0);
                    a.x = e.x + o.clientLeft,
                    a.y = e.y + o.clientTop
                }
                return {
                    ...t,
                    x: t.x - n.scrollLeft + a.x,
                    y: t.y - n.scrollTop + a.y
                }
            },
            isElement: z,
            getDimensions: q,
            ...
            isRTL: e => "rtl" === E(e).direction
        };
        const Q = (e, t, o) => (async (e, t, o) => {
            const {placement: i="bottom", strategy: s="absolute", middleware: r=[], platform: n} = o
              , a = await (null == n.isRTL ? void 0 : n.isRTL(t));
            ...
            for (let o = 0; o < r.length; o++) {
                const {name: g, fn: y} = r[o]
                  , {x: f, y: v, data: w, reset: b} = await y({
                    x: h,
                    y: d,
                    initialPlacement: i,
                    placement: m,
                ...
                b.rects && (l = !0 === b.rects ? await n.getElementRects({
                    reference: e,
                    floating: t,
                    strategy: s
                }) : b.rects),
        ...
        async function ee(e, t, o, i) {
            ...
            return await ("string" == typeof i ? async function(e, t, o, i) {
                if (!o)
                ...
                function(e, t, o, i) {
                    void 0 === i && (i = {});
                    const {ancestorScroll: s=!0, ancestorResize: r=!0, elementResize: n=!0, animationFrame: a=!1} = i
                      , c = s && !a
                      , l = r && !a
                      , h = c || l ? [...z(e) ? Z(e) : [], ...Z(t)] : [];
                    h.forEach((e => {
                        c && e.addEventListener("scroll", o, {
                            passive: !0
                        }),
                    ...
                    return a && function t() {
                        const i = V(e);
                        u && (i.x !== u.x || i.y !== u.y || i.width !== u.width || i.height !== u.height) && o(),
                        u = i,
                    ...
                    () => {
                        var e;
                        h.forEach((e => {
                            c && e.removeEventListener("scroll", o),
                    ...
                    if ((!o.isConnected || !o.offsetParent) && function(e) {
                        switch (e.options.onPositionLost) {
                        case "close":
                            return e.close(),
                            !0;
                        case "destroy":
        ...
        const ie = (0,
        i.getPrefixedClasses)("popupContainer", "closeButton");
        class se {
            constructor(e, t) {
                this.isOpen = !1,
                this.externalEvents = new i.Events,
                this.options = {
                    ...oe(t),
                    ...(0,
                    i.getOptions)(e)
                ...
                this.popupEl.classList.add(ie.popupContainer),
                this.popupEl.classList.add(this.options.theme),
                t.className && this.popupEl.classList.add(t.className),
                this.options.showCloseButton && (this.closeButton = document.createElement("button"),
                this.closeButton.type = "button",
                this.closeButton.classList.add(ie.closeButton),
                ...
                this.focusTrap = new i.FocusTrap,
                ...
                this.options.hideOnEmojiSelect && this.picker.addEventListener("emoji:select", ( () => {
                    var e;
                    this.close(),
                    null == (e = this.triggerElement) || e.focus()
                }
                )),
                this.options.hideOnClickOutside && (this.onDocumentClick = this.onDocumentClick.bind(this),
                document.addEventListener("click", this.onDocumentClick)),
                this.options.hideOnEscape && (this.handleKeydown = this.handleKeydown.bind(this),
            ...
            addEventListener(e, t) {
                ...
                this.picker.addEventListener(e, t)
            }
            removeEventListener(e, t) {
                this.externalEvents.off(e, t),
                this.picker.removeEventListener(e, t)
            }
            handleKeydown(e) {
                var t;
                "Escape" === e.key && (this.close(),
                null == (t = this.triggerElement) || t.focus())
            }
            async destroy() {
            ...
            async open({triggerElement: e, referenceElement: t}={}) {
                this.isOpen || (e && (this.triggerElement = e),
            ...
            async close() {
                var e;
                !this.isOpen || (await this.initiateOpenStateChange(!1),
                await this.animateCloseButton(!1),
                await this.animatePopup(!1),
                this.popupEl.remove(),
                this.picker.reset(),
                null == (e = this.positionCleanup) || e.call(this),
            ...
            async setPosition() {
                var e;
                null == (e = this.positionCleanup) || e.call(this),
                this.positionCleanup = await ee(this, this.popupEl, this.referenceElement, this.options.position)
            }
            ...
            onDocumentClick(e) {
                var t;
                const o = e.target
                  , i = null == (t = this.triggerElement) ? void 0 : t.contains(o);
                this.isOpen && !this.picker.isPickerClick(e) && !i && this.close()
            }
            animatePopup(e) {
                return (0,
                i.animate)(this.popupEl, {
                    opacity: [0, 1],
        ...
        const re = ".picmo__popupContainer{display:flex;flex-direction:column;position:absolute}.picmo__popupContainer .picmo__closeButton{position:absolute;opacity:0;background:transparent;border:none;z-index:1;right:0;top:0;cursor:pointer;padding:4px;align-self:flex-end;transform:translate(50%,-50%);background:#999999;width:1.5rem;height:1.5rem;display:flex;align-items:center;justify-content:center;border-radius:50%}.picmo__popupContainer .picmo__closeButton:hover{background:var(--accent-color)}.picmo__popupContainer .picmo__closeButton svg{fill:#fff;width:1.25rem;height:1.25rem}\n"
          , ne = (0,
        i.createStyleInjector)();
        function ae(e, t) {
            return ne(re),
            new se({
                autoFocus: "auto",
    ...
    7741: (e, t, o) => {
        ...
        o.d(t, {
            ...
            FocusTrap: () => N,
            InMemoryProvider: () => Ht,
            InMemoryStoreFactory: () => T,
            IndexedDbStoreFactory: () => ge,
            LocalStorageProvider: () => Ce,
            NativeRenderer: () => me,
            RecentsProvider: () => ve,
            Renderer: () => he,
            SessionStorageProvider: () => Nt,
            animate: () => w,
            autoTheme: () => W,
            caseInsensitiveIncludes: () => y,
            computeHash: () => C,
            createDatabase: () => Kt,
            createPicker: () => Dt,
            createStyleInjector: () => Tt,
            darkTheme: () => K,
            debounce: () => v,
            deleteDatabase: () => O,
            empty: () => _,
            ...
            getEmojiForEvent: () => p,
            getOptions: () => ke,
            getPrefixedClasses: () => j,
            globalConfig: () => ze,
            i18n: () => Ot,
            isLocalStorageAvailable: () => L,
            isSessionStorageAvailable: () => S,
            lightTheme: () => H,
            prefixClassName: () => k,
            replaceChildren: () => x,
            shouldAnimate: () => g,
        ...
        var i = (e, t, o) => {
          ...
          , s = (e, t, o) => (i(e, t, "read from private field"),
        o ? o.call(e) : t.get(e))
          , r = (e, t, o) => {
            if (t.has(e))
          ...
          , n = (e, t, o, s) => (i(e, t, "write to private field"),
        s ? s.call(e, o) : t.set(e, o),
        o)
          , a = (e, t, o) => (i(e, t, "access private method"),
        o);
        async function c(e, t={}) {
            const {local: o=!1, version: i="latest", cdnUrl: s, ...r} = t
              , n = function(e, t, o) {
                let i = `https://cdn.jsdelivr.net/npm/emojibase-data@${t}/${e}`;
                return "function" == typeof o ? i = o(e, t) : "string" == typeof o && (i = `${o}/${e}`),
                i
            }(e, i, s)
        ...
        async function h(e, t, o) {
            var i;
            return c(`${e}/shortcodes/${null !== (i = l[t]) && void 0 !== i ? i : t}.json`, o)
        }
        function d(e, t) {
            if (0 === t.length)
                return e;
        ...
        async function m(e, t={}) {
            const {compact: o=!1, flat: i=!1, shortcodes: s=[], ...r} = t
              , n = await c(`${e}/${o ? "compact" : "data"}.json`, r);
            let a = [];
            return s.length > 0 && (a = await Promise.all(s.map((t => {
                let o;
                if (t.includes("/")) {
                    const [e,i] = t.split("/");
                    o = h(e, i, r)
        ...
        function w(e, t, o, i) {
            if (g(i) && e.animate)
                return e.animate(t, o).finished;
            const s = "normal" === o.direction ? 1 : 0
              , r = Object.entries(t).reduce(( (e, [t,o]) => ({
                ...e,
                [t]: o[s]
            })), {});
        ...
        function b(e) {
            ...
            null == (t = o.content) ? void 0 : t.firstElementChild
        }
        async function C(e) {
        ...
        function P(e) {
            ...
            return {
                ...
                label: e.label,
                tags: e.tags,
                skins: null == (t = e.skins) ? void 0 : t.map((e => P(e))),
                order: e.order,
                custom: !1,
                hexcode: e.hexcode,
                version: e.version
        ...
        function z(e, t, o) {
            var i;
            return !(o && !o.some((t => t.order === e.group))) && (y(e.label, t) || (null == (i = e.tags) ? void 0 : i.some((e => y(e, t)))))
        }
        class F {
            constructor(e="en") {
                this.locale = e
        ...
        const A = [ (e, t) => ("1F91D" === e.hexcode && t < 14 && (e.skins = []),
        e), (e, t) => (e.skins && (e.skins = e.skins.filter((e => !e.version || e.version <= t))),
        e)];
        function $(e, t) {
            return e.filter((e => null !== function(e, t) {
                return A.some((o => null === o(e, t))) ? null : e
            }(e, t)))
        }
        const R = {};
        function T(e) {
        ...
        class I extends F {
            ...
            populate(e) {
                return this.categories = e.groups,
            ...
            getEmojis(e, t) {
                const o = this.emojis.filter((t => t.group === e.order)).filter((e => e.version <= t)).sort(( (e, t) => null != e.order && null != t.order ? e.order - t.order : 0)).map(P);
                return Promise.resolve($(o, t))
            }
            searchEmojis(e, t, o, i) {
                const s = this.emojis.filter((t => z(t, e, i) && t.version <= o)).map(P)
                  , r = t.filter((t => z(t, e, i)))
                  , n = [...$(s, o), ...r];
        ...
        async function V(e, t, o) {
            ...
            const i = await M(e, t, o)
              , [s,r] = await function(e) {
                ...
                try {
                    return Promise.all([B(t), B(o)])
                } catch {
                    return Promise.all([null, null])
                }
            }(e);
            if (await i.isPopulated())
                s && r && await async function(e, t, o) {
                    let i;
                    try {
                        i = await e.getEtags()
                    } catch {
                    ...
                    if (o !== r || t !== s) {
                        const [i,s] = await Promise.all([u(e.locale), m(e.locale)]);
                        await e.populate({
                            groups: i.groups,
                            emojis: s,
                            emojisEtag: t,
                ...
                const [t,o] = await Promise.all([u(e), m(e)]);
                await i.populate({
                    groups: t.groups,
                    emojis: o,
                    emojisEtag: s,
        ...
        const {light: H, dark: K, auto: W} = j("light", "dark", "auto");
        class U {
            ...
            updateEmojiData(e) {
                this.emojiData = e,
                this.emojiDataPromise = Promise.resolve(e)
            }
            setOptions(e) {
                this.options = e
            }
            ...
            async render(e={}) {
                return await this.emojiDataPromise,
            ...
            scheduleShowAnimation() {
                if (this.parent) {
                    const e = new MutationObserver((t => {
                        const [o] = t;
                        "childList" === o.type && o.addedNodes[0] === this.el && (g(this.options) && this.animateShow && this.animateShow(),
                        e.disconnect)
                    }
                    ));
        ...
        function Z(e, t) {
            ...
            const o = function(e, t) {
                const o = b(t);
                return o.dataset.icon = e,
                o.classList.add(k("icon")),
                o
            }(e, q[e]);
            return t && o.classList.add(k(`icon-${t}`)),
            o
        }
        const J = "sync";
        var Y, X, Q, ee, te, oe, ie, se;
        class re {
            constructor(e, t={}) {
                r(this, Q),
                r(this, te),
            ...
            renderSync(e={}) {
                const t = b(s(this, Y).call(this, e));
                return a(this, ie, se).call(this, t, e),
                a(this, te, oe).call(this, t),
                a(this, Q, ee).call(this, t, e),
                t
            }
            async renderAsync(e={}) {
                const t = b(s(this, Y).call(this, e));
                return a(this, ie, se).call(this, t, e),
                a(this, te, oe).call(this, t),
                await a(this, Q, ee).call(this, t, e),
                t
            }
            render(e) {
                return "sync" === s(this, X) ? this.renderSync(e) : this.renderAsync(e)
            }
        }
        Y = new WeakMap,
        X = new WeakMap,
        ...
        ee = async function(e, t) {
            ...
            for (const e of o) {
                ...
                o ? "sync" !== e.dataset.render ? i.push(o.render().then((t => (e.replaceWith(t),
                t)))) : e.replaceWith(o.renderSync()) : e.remove()
            }
        ...
        se = function(e, t) {
            return e.querySelectorAll("[data-placeholder]").forEach((e => {
                ...
                if (o && t[o]) {
                    ...
                    console.warn(`Missing placeholder element for key "${o}"`)
            }
            )),
            e
        }
        ;
        const ne = j("imagePlaceholder", "placeholder")
        ...
        class ce extends U {
            ...
            renderSync() {
                ...
                this.classNames && this.classNames.split(" ").forEach((e => this.el.classList.add(e))),
                this.el
            }
        }
        const le = j("customEmoji");
        class he {
            renderElement(e) {
                return {
                    content: e
            ...
            renderCustom(e, t, o="") {
                const i = [le.customEmoji, o].join(" ").trim()
                  , {content: s, resolver: r} = this.renderImage(i, ( () => e.url))
                  , n = s instanceof Element ? s : s.el;
                return r && r(),
                n
            }
        }
        const de = new re(( ({emoji: e}) => `<span>${e}</span>`));
        class me extends he {
            render(e) {
                return this.renderElement(de.renderSync({
                    emoji: e.emoji
                }))
            }
        ...
        ge.deleteDatabase = e => new Promise(( (t, o) => {
            const i = indexedDB.deleteDatabase(`${pe}-${e}`);
            i.addEventListener("success", t),
            i.addEventListener("error", o)
        }
        ));
        class ye extends F {
            async open() {
                const e = indexedDB.open(`${pe}-${this.locale}`);
                return new Promise(( (t, o) => {
                    e.addEventListener("success", (e => {
                        var o;
                        this.db = null == (o = e.target) ? void 0 : o.result,
                        t()
                    }
                    )),
                    e.addEventListener("error", o),
                    e.addEventListener("upgradeneeded", (async e => {
                        var t;
                        this.db = null == (t = e.target) ? void 0 : t.result,
            ...
            async delete() {
                this.close();
                const e = indexedDB.deleteDatabase(`${pe}-${this.locale}`);
            ...
            async setMeta(e) {
                ...
                return new Promise((i => {
                    t.oncomplete = i,
                    Object.keys(e).filter(Boolean).forEach((t => {
                        o.put(e[t], t)
                    }
                    ))
                }
            ...
            async populate({groups: e, emojis: t, emojisEtag: o, messagesEtag: i, hash: s}) {
            ...
            async getCategories(e) {
                ...
                e.categories) {
                    const t = e.categories;
                    i = i.filter((e => t.includes(e.key))),
                    i.sort(( (e, o) => t.indexOf(e.key) - t.indexOf(o.key)))
                } else
            ...
            async getEmojis(e, t) {
                ...
                return $((await this.waitForRequest(o.getAll(e.order))).target.result.filter((e => e.version <= t)).sort(( (e, t) => null != e.order && null != t.order ? e.order - t.order : 0)).map(P), t)
            }
            async searchEmojis(e, t, o, i) {
                const s = [];
                return new Promise(( (r, n) => {
                    const a = this.db.transaction("emoji", "readonly").objectStore("emoji").openCursor();
                    a.addEventListener("success", (n => {
                        var a;
                        const c = null == (a = n.target) ? void 0 : a.result;
                        if (!c)
                            return r([...$(s, o), ...t.filter((t => z(t, e)))]);
                        const l = c.value;
                        z(l, e, i) && l.version <= o && s.push(P(l)),
                        c.continue()
                    }
                    )),
        ...
        class be extends ve {
            ...
            getRecents(e) {
                var t;
                try {
                    return JSON.parse(null != (t = this.storage.getItem(we)) ? t : "[]").slice(0, e)
                } catch {
                    return []
                }
            }
            addOrUpdateRecent(e, t) {
                ...
                try {
                    this.storage.setItem(we, JSON.stringify(o))
                } catch {
        ...
        function ke(e={}) {
            return {
                ...je,
                ...e,
                renderer: e.renderer || new me,
                recentsProvider: e.recentsProvider || new Ce
            }
        }
        var _e, xe, Ee, Se, Le;
        class Pe {
            ...
            on(e, t, o) {
                a(this, Se, Le).call(this, e, t, o)
            }
            once(e, t, o) {
                a(this, Se, Le).call(this, e, t, o, !0)
            }
            off(e, t) {
                const o = a(this, xe, Ee).call(this, e);
                s(this, _e).set(e, o.filter((e => e.handler !== t)))
            }
            emit(e, ...t) {
                a(this, xe, Ee).call(this, e).forEach((o => {
                    o.handler.apply(o.context, t),
                    o.once && this.off(e, o.handler)
                }
                ))
            }
            removeAll() {
        ...
        xe = new WeakSet,
        Ee = function(e) {
            return s(this, _e).has(e) || s(this, _e).set(e, []),
            s(this, _e).get(e)
        }
        ,
        Se = new WeakSet,
        Le = function(e, t, o, i=!1) {
            a(this, xe, Ee).call(this, e).push({
                context: o,
                handler: t,
                once: i
            })
        ...
        const $e = j("emojiCategory", "categoryName", "noRecents", "recentEmojis");
        class Re extends U {
            constructor({template: e, category: t, showVariants: o, lazyLoader: i}) {
                ...
                this.baseUIElements = {
                    categoryName: U.byClass($e.categoryName)
                },
                this.category = t,
                this.showVariants = o,
                this.lazyLoader = i
        ...
        const Te = new re(( ({classes: e, emoji: t}) => `\n  <button\n    type="button"\n    class="${e.emojiButton}"\n    title="${t.label}"\n    data-emoji="${t.emoji}"\n    tabindex="-1">\n    <div data-placeholder="emojiContent"></div>\n  </button>\n`))
          , Ie = j("emojiButton");
        class Be extends U {
            ...
            initialize() {
                this.uiEvents = [U.uiEvent("focus", this.handleFocus)],
                super.initialize()
            }
            handleFocus() {
        ...
        class Me {
            ...
            handleKeyDown(e) {
                e.key in this.keyHandlers && (e.preventDefault(),
            ...
            setCell(e, t, o=!0) {
                ...
                (this.focusedRow >= this.rowCount || this.getIndex() >= this.emojiCount) && (this.focusedRow = this.rowCount - 1,
        ...
        const Ve = new re(( ({classes: e}) => `\n  <div class="${e.emojiContainer}">\n    <div data-placeholder="emojis"></div>\n  </div>\n`))
          , De = j("emojiContainer");
        class Oe extends U {
            constructor({emojis: e, showVariants: t, preview: o=!0, lazyLoader: i, category: s, fullHeight: r=!1}) {
                super({
                    template: Ve,
                    classes: De
                }),
            ...
            initialize() {
                this.grid = new Me(this.options.emojisPerRow,this.emojiCount,0,0,!this.category),
                ...
                this.uiEvents = [U.uiEvent("click", this.selectEmoji), U.uiEvent("keydown", this.grid.handleKeyDown)],
                this.preview && this.uiEvents.push(U.uiEvent("mouseover", this.showPreview), U.uiEvent("mouseout", this.hidePreview), U.uiEvent("focus", this.showPreview, {
                    capture: !0
                }), U.uiEvent("blur", this.hidePreview, {
                    capture: !0
                })),
                super.initialize()
            }
                ...
                if (e)
                    if ("string" == typeof e) {
                        ...
                        setTimeout(( () => {
                            ...
                            r.scrollIntoView();
                            const n = null == (e = r.parentElement) ? void 0 : e.previousElementSibling;
                            (null == (i = null == (o = r.parentElement) ? void 0 : o.parentElement) ? void 0 : i.parentElement).scrollTop -= null != (s = null == n ? void 0 : n.offsetHeight) ? s : 0
                        }
                        ))
                    } else
                        "first" === e.row || 0 === e.row ? this.grid.setCell(0, e.offset, t) : "last" === e.row && this.grid.setCell(this.grid.getRowCount() - 1, e.offset, t)
            }
            setActive(e, t, o) {
                var i;
            ...
            renderSync() {
                return this.emojiViews = this.emojis.map((e => this.viewFactory.create(Be, {
                    emoji: e,
            ...
            setFocus({from: e, to: t, performFocus: o}) {
                var i, s;
                null == (i = this.emojiViews[e]) || i.deactivateFocus(),
                null == (s = this.emojiViews[t]) || s.activateFocus(o)
            }
            selectEmoji(e) {
                e.stopPropagation();
                const t = p(e, this.emojis);
            ...
            hidePreview(e) {
                p(e, this.emojis) && this.events.emit("preview:hide")
            }
            get emojiCount() {
                return this.emojis.length
            }
        }
        const Ne = new re(( ({classes: e, category: t, pickerId: o, icon: i, i18n: s}) => `\n  <section class="${e.emojiCategory}" role="tabpanel" aria-labelledby="${o}-category-${t.key}">\n    <h3 data-category="${t.key}" class="${e.categoryName}">\n      <i data-icon="${i}"></i>\n      ${s.get(`categories.${t.key}`, t.message || t.key)}\n    </h3>\n    <div data-view="emojis" data-render="sync"></div>\n  </section>\n`));
        class He extends Re {
            ...
            async render() {
                ...
                return this.emojiContainer = this.viewFactory.create(Oe, {
                    emojis: e,
                    showVariants: this.showVariants,
                    lazyLoader: this.lazyLoader,
        ...
        class Ke extends Oe {
            ...
            async addOrUpdate(e) {
                ...
                t && (this.el.removeChild(t),
                this.emojis = this.emojis.filter((t => t !== e)));
                const o = this.viewFactory.create(Be, {
                    emoji: e
                });
                if (this.el.insertBefore(o.renderSync(), this.el.firstChild),
                this.emojis = [e, ...this.emojis.filter((t => t !== e))],
        ...
        const Ge = j("emojiArea")
          , Ze = new re(( ({classes: e}) => `\n  <div class="${e.emojiArea}">\n    <div data-placeholder="emojis"></div>\n  </div>\n`),{
            mode: "async"
        })
          , Je = {
            recents: class extends Re {
                ...
                initialize() {
                    this.uiElements = {
                        ...this.baseUIElements,
                        recents: U.byClass($e.recentEmojis)
                    },
                    this.appEvents = {
                ...
                async render() {
                    ...
                    return this.emojiContainer = this.viewFactory.create(Ke, {
                        emojis: t,
                        showVariants: !1,
                        lazyLoader: this.lazyLoader,
                        category: this.category.key
        ...
        class Ye extends U {
            constructor({categoryTabs: e, categories: t, emojiVersion: o}) {
                ...
                this.lazyLoader = new qe,
                this.categoryTabs = e,
                this.categories = t,
                this.emojiVersion = o,
                this.handleScroll = f(this.handleScroll.bind(this), 100)
            }
            initialize() {
                this.appEvents = {
                ...
                this.uiElements = {
                    emojis: U.byClass(Ge.emojiArea)
                },
                this.uiEvents = [U.uiEvent("scroll", this.handleScroll)],
                super.initialize()
            }
            get focusableEmoji() {
            ...
            destroy() {
                ...
                this.emojiCategories.forEach((e => {
                    var t;
                    null == (t = this.observer) || t.unobserve(e.el),
                    e.destroy()
                }
                ))
            }
            ...
            async selectCategory(e, t={}) {
                ...
                const n = this.selectedCategory = "number" == typeof e ? e : this.getCategoryIndex(e);
                null == (o = this.categoryTabs) || o.setActiveTab(this.selectedCategory, {
                    performFocus: s,
                    scroll: "button" === i
                });
                const a = this.emojiCategories[n].el.offsetTop;
                var c;
                this.emojiCategories[n].setActive(!0, (c = i) && "button" !== c ? c : {
                    row: "first",
                    offset: 0
                }, "button" !== i && s),
                r && (this.el.scrollTop = a),
                this.scrollListenerState = "resume"
            }
            updateFocusedCategory(e) {
                var t;
                this.categories[this.selectedCategory].key !== e && (this.scrollListenerState = "suspend",
                this.selectedCategory = this.getCategoryIndex(e),
                null == (t = this.categoryTabs) || t.setActiveTab(this.selectedCategory, {
                    changeFocusable: !1,
                    performFocus: !1
                }),
                this.scrollListenerState = "resume")
            ...
            handleScroll() {
                if ("suspend" === this.scrollListenerState || !this.categoryTabs)
                    return;
        ...
        const Xe = new re(( ({classList: e, classes: t, icon: o, message: i}) => `\n<div class="${e}" role="alert">\n  <div class="${t.iconContainer}"><i data-size="10x" data-icon="${o}"></i></div>\n  <h3 class="${t.title}">${i}</h3>\n</div>\n`))
          , Qe = j("error", "iconContainer", "title");
        class et extends U {
            constructor({message: e, icon: t="warning", template: o=Xe, className: i}) {
                super({
                    template: o,
                    classes: Qe
                }),
        ...
        class it extends et {
            ...
            initialize() {
                ...
                this.uiEvents = [U.childEvent("retryButton", "click", this.onRetry)],
                super.initialize()
            }
            async onRetry() {
                this.emojiData ? await this.emojiData.delete() : await this.options.dataStore.deleteDatabase(this.options.locale),
                this.events.emit("reinitialize");
                const e = await D(this.options.locale, this.options.dataStore, this.options.messages, this.options.emojiData, this.emojiData);
                this.viewFactory.setEmojiData(e),
                this.events.emit("data:ready", e)
            }
        }
        const st = j("preview", "previewEmoji", "previewName", "tagList", "tag")
          , rt = new re(( ({classes: e, tag: t}) => `\n  <li class="${e.tag}">${t}</li>\n`))
        ...
        class at extends U {
            ...
            initialize() {
                this.uiElements = {
                    emoji: U.byClass(st.previewEmoji),
                    name: U.byClass(st.previewName),
                    tagList: U.byClass(st.tagList)
                },
                this.appEvents = {
        ...
        const ct = new re(( ({classes: e, i18n: t}) => `\n  <button title="${t.get("search.clear")}" class="${e.clearSearchButton}">\n    <i data-icon="xmark"></i>\n  </button>\n`))
          , lt = new re(( ({classes: e, i18n: t}) => `\n<div class="${e.searchContainer}">\n  <input class="${e.searchField}" placeholder="${t.get("search")}">\n  <span class="${e.searchAccessory}"></span>\n</div>\n`),{
            mode: "async"
        })
          , ht = j("searchContainer", "searchField", "clearButton", "searchAccessory", "clearSearchButton", "notFound");
        class dt extends U {
            constructor({categories: e, emojiVersion: t}) {
                ...
                this.emojiVersion = t,
                this.search = v(this.search.bind(this), 100)
            }
            initialize() {
                this.uiElements = {
                    searchField: U.byClass(ht.searchField),
                    searchAccessory: U.byClass(ht.searchAccessory)
                },
                this.uiEvents = [U.childEvent("searchField", "keydown", this.onKeyDown), U.childEvent("searchField", "input", this.onSearchInput)],
                super.initialize()
            }
            async render() {
                return await super.render(),
                this.searchIcon = Z("search"),
                this.notFoundMessage = this.viewFactory.create(et, {
                    message: this.i18n.get("search.notFound"),
                    className: ht.notFound,
                    icon: "sad"
                }),
                this.notFoundMessage.renderSync(),
                this.errorMessage = this.viewFactory.create(et, {
                    message: this.i18n.get("search.error")
                }),
                this.errorMessage.renderSync(),
                this.clearSearchButton = ct.render({
                    classes: ht,
                    i18n: this.i18n
                }),
                this.clearSearchButton.addEventListener("click", (e => this.onClearSearch(e))),
            ...
            onClearSearch(e) {
                ...
                e.stopPropagation(),
                this.searchField.value = "",
                null == (t = this.resultsContainer) || t.destroy(),
            ...
            onKeyDown(e) {
                var t;
                "Escape" === e.key && this.searchField.value ? this.onClearSearch(e) : ("Enter" === e.key || "ArrowDown" === e.key) && this.resultsContainer && (e.preventDefault(),
                null == (t = this.resultsContainer.el.querySelector('[tabindex="0"]')) || t.focus())
            }
            onSearchInput(e) {
                this.searchField.value ? (this.showClearSearchButton(),
                this.search()) : this.onClearSearch(e)
            }
            async search() {
                var e;
                if (this.searchField.value)
                    try {
                        ...
                        if (this.events.emit("preview:hide"),
                        t.length) {
                            const o = new qe;
                            this.resultsContainer = this.viewFactory.create(Oe, {
                                emojis: t,
                                fullHeight: !0,
                                showVariants: !0,
                                lazyLoader: o
                            ...
                            null != (e = this.resultsContainer) && e.el && (o.observe(this.resultsContainer.el),
                            this.resultsContainer.setActive(!0, {
                                row: 0,
                                offset: 0
                            }, !1),
                            this.resultsContainer.el.addEventListener("keydown", (e => this.handleResultsKeydown(e))),
        ...
        const mt = new re(( ({classes: e}) => `\n  <div class="${e.variantOverlay}">\n    <div class="${e.variantPopup}">\n      <div data-view="emojis" data-render="sync"></div>\n    </div>\n  </div>\n`))
          , ut = j("variantOverlay", "variantPopup")
          , pt = {
            easing: "ease-in-out",
            duration: 250,
            fill: "both"
        ...
        class ft extends U {
            constructor({emoji: e, parent: t}) {
                ...
                this.focusTrap = new N,
                this.animateShow = () => Promise.all([w(this.el, gt, pt, this.options), w(this.ui.popup, yt, pt, this.options)]),
                this.emoji = e
            }
            initialize() {
                this.uiElements = {
                    popup: U.byClass(ut.variantPopup)
                },
                this.uiEvents = [U.uiEvent("click", this.handleClick), U.uiEvent("keydown", this.handleKeydown)],
                super.initialize()
            }
            animateHide() {
                const e = {
                ...
                return Promise.all([w(this.el, gt, e, this.options), w(this.ui.popup, yt, e, this.options)])
            }
            async hide() {
            ...
            renderSync() {
                ...
                e.length < this.options.emojisPerRow && this.el.style.setProperty("--emojis-per-row", e.length.toString()),
                this.el
            }
            activate() {
        ...
        const vt = new re(( ({classes: e, i18n: t, category: o, pickerId: i, icon: s}) => `\n<li class="${e.categoryTab}">\n  <button\n    aria-selected="false"\n    role="tab"\n    class="${e.categoryButton}"\n    tabindex="-1"\n    title="${t.get(`categories.${o.key}`, o.message || o.key)}"\n    type="button"\n    data-category="${o.key}"\n    id="${i}-category-${o.key}"\n  >\n    <i data-icon="${s}"></i>\n</li>\n`))
          , wt = j("categoryTab", "categoryTabActive", "categoryButton");
        class bt extends U {
            ...
            initialize() {
                this.uiElements = {
                    button: U.byClass(wt.categoryButton)
                },
                this.uiEvents = [U.childEvent("button", "click", this.selectCategory), U.childEvent("button", "focus", this.selectCategory)],
                super.initialize()
            }
            renderSync() {
                return super.renderSync({
            ...
            setActive(e, t={}) {
                const {changeFocusable: o, performFocus: i, scroll: s} = {
                    changeFocusable: !0,
                    performFocus: !0,
                    scroll: !0,
                    ...t
                };
                this.el.classList.toggle(wt.categoryTabActive, e),
                o && (this.ui.button.tabIndex = e ? 0 : -1,
                this.ui.button.ariaSelected = e.toString()),
                e && i && (this.ui.button.focus(),
                s && this.events.emit("category:select", this.category.key, {
                    scroll: "animate",
                    focus: "button",
                    performFocus: !1
                })),
        ...
        const Ct = new re(( ({classes: e}) => `\n  <div class="${e.categoryButtonsContainer}">\n    <ul role="tablist" class="${e.categoryButtons}">\n      <div data-placeholder="tabs"></div>\n    </ul>\n  </div>\n`))
          , jt = j("categoryButtons", "categoryButtonsContainer");
        class kt extends U {
            ...
            initialize() {
                ...
                this.uiEvents = [U.uiEvent("scroll", this.checkOverflow)],
                super.initialize()
            }
            checkOverflow() {
                ...
                t && e ? this.el.classList.add("has-overflow-both") : t ? this.el.classList.add("has-overflow-left") : e && this.el.classList.add("has-overflow-right")
            }
            renderSync() {
                return this.tabViews = this.categories.map((e => this.viewFactory.create(bt, {
                    category: e,
                    icon: G[e.key]
                }))),
                super.renderSync({
        ...
        const Lt = new re((e => e.isLoaded ? function(e) {
          ...
          , Pt = j("picker", "skeleton", "placeholder", "searchSkeleton", "searchInput", "categoryTabsSkeleton", "headerSkeleton", "categoryTab", "contentSkeleton", "categoryName", "emojiGrid", "emoji", "previewSkeleton", "previewEmoji", "previewName", "tagList", "tag", "overlay", "content", "fullHeight", "pluginContainer", "header")
          , zt = {
        ...
        class Ft extends U {
            constructor() {
                ...
                this.pickerReady = !1,
                this.externalEvents = new Ae,
                this.updaters = {
                    styleProperty: e => t => this.el.style.setProperty(zt[e], t.toString()),
                    theme: e => {
                        const t = this.options.theme
                          , o = this.el.closest(`.${t}`);
                        this.el.classList.remove(t),
                        null == o || o.classList.remove(t),
                        this.el.classList.add(e),
                        null == o || o.classList.add(e)
                    }
                    ,
                    className: e => {
                        this.options.className && this.el.classList.remove(this.options.className),
                        this.el.classList.add(e)
                    }
                    ,
            ...
            initialize() {
                this.uiElements = {
                    pickerContent: U.byClass(Pt.content),
                    header: U.byClass(Pt.header)
                },
                this.uiEvents = [U.uiEvent("keydown", this.handleKeyDown)],
                this.appEvents = {
                    error: this.onError,
            ...
            destroy() {
                ...
                null == (t = this.categoryTabs) || t.destroy(),
                this.events.removeAll(),
                this.externalEvents.removeAll()
            }
            clearRecents() {
            ...
            initializePickerView() {
                ...
                this.emojiArea.reset(!1))
            }
            handleKeyDown(e) {
                const t = e.ctrlKey || e.metaKey;
                "s" === e.key && t && this.search && (e.preventDefault(),
                this.search.focus())
            }
            buildChildViews() {
                return this.options.showPreview && (this.preview = this.viewFactory.create(at)),
                this.options.showSearch && (this.search = this.viewFactory.create(dt, {
                    categories: this.categories,
                    emojiVersion: this.emojiVersion
                })),
                this.options.showCategoryTabs && (this.categoryTabs = this.viewFactory.create(kt, {
                    categories: this.categories
                })),
                this.currentView = this.emojiArea = this.viewFactory.create(Ye, {
            ...
            setStyleProperties() {
                this.options.showSearch || this.el.style.setProperty("--search-height-full", "0px"),
                this.options.showCategoryTabs || (this.el.style.setProperty("--category-tabs-height", "0px"),
                this.el.style.setProperty("--category-tabs-offset", "0px")),
                this.options.showPreview || this.el.style.setProperty("--emoji-preview-height-full", "0px"),
                Object.keys(zt).forEach((e => {
                    this.options[e] && this.el.style.setProperty(zt[e], this.options[e].toString())
                }
                ))
            }
            updateStyleProperty(e, t) {
                this.el.style.setProperty(zt[e], t.toString())
            }
            reinitialize() {
                this.renderSync()
            }
            onError(e) {
                ...
                throw this.el.style.height = `${o}px`,
                x(this.el, t.renderSync()),
                e
            }
            async onDataReady(e) {
                const t = this.el;
                try {
                    ...
                    "auto" === this.options.emojiVersion ? this.emojiVersion = xt() || parseFloat("14.0") : this.emojiVersion = this.options.emojiVersion,
            ...
            renderSync() {
                ...
                if (this.options.showRecents && (t += 1),
                super.renderSync({
                    isLoaded: !1,
                    theme: this.options.theme,
                    className: this.options.className,
            ...
            getInitialFocusTarget() {
                ...
                if (!0 === this.options.autoFocusSearch)
                    return console.warn("options.autoFocusSearch is deprecated, please use options.focusTarget instead"),
                    this.search
            }
            setInitialFocus() {
                var e;
            ...
            reset(e=!0) {
                var t;
                this.pickerReady && (this.emojiArea.reset(e),
                this.showContent(this.emojiArea)),
                null == (t = this.search) || t.clear(),
                this.hideVariantPopup()
            }
            showContent(e=this.emojiArea) {
                var t, o;
                e !== this.currentView && (this.currentView !== this.emojiArea && (null == (t = this.currentView) || t.destroy()),
                this.ui.pickerContent.classList.toggle(Pt.fullHeight, e !== this.emojiArea),
                x(this.ui.pickerContent, e.el),
                this.currentView = e,
                e === this.emojiArea ? (this.emojiArea.reset(),
                this.categoryTabs && this.ui.header.appendChild(this.categoryTabs.el)) : null == (o = this.categoryTabs) || o.el.remove())
            }
            hideVariantPopup() {
                var e;
            ...
            async selectEmoji({emoji: e}) {
                var t, o;
                (null == (t = e.skins) ? void 0 : t.length) && this.options.showVariants && !this.isVariantPopupOpen ? this.showVariantPopup(e) : (await (null == (o = this.variantPopup) ? void 0 : o.animateHide()),
                this.events.emit("variantPopup:hide"),
            ...
            async showVariantPopup(e) {
                ...
                this.variantPopup = this.viewFactory.create(ft, {
                    emoji: e,
                    parent: this.el
                }),
            ...
            async emitEmoji(e) {
                this.externalEvents.emit("emoji:select", await this.renderer.doEmit(e)),
        ...
        class At {
            constructor({events: e, i18n: t, renderer: o, emojiData: i, options: s, customEmojis: r=[], pickerId: n}) {
                this.events = e,
                this.i18n = t,
                this.renderer = o,
                this.emojiData = i,
            ...
            createWithOptions(e={}, t, ...o) {
                const i = new t(...o);
                return i.setPickerId(this.pickerId),
                i.setEvents(this.events),
                i.setI18n(this.i18n),
                i.setRenderer(this.renderer),
                !1 !== e.data && i.setEmojiData(this.emojiData),
                i.setOptions(this.options),
                i.setCustomEmojis(this.customEmojis),
                i.viewFactory = this,
                i.initialize(),
                i
            }
        ...
        class Rt {
            constructor(e={}) {
                r(this, $t, void 0),
                n(this, $t, new Map(Object.entries(e)))
            }
            get(e, t=e) {
                return s(this, $t).get(e) || t
            }
        }
        function Tt() {
            let e = !1;
            return function(t) {
                ze.injectStyles && !e && (function(e, t) {
                    void 0 === t && (t = {});
                    var o = t.insertAt;
        ...
        function Dt(e) {
            ...
            const t = ke(e)
              ...
              , i = new Fe;
            Bt || (Bt = function(e) {
                return D(e.locale, e.dataStore, e.messages, e.emojiData)
            }(t));
            const s = new Rt(t.i18n);
            Bt.then((e => {
                i.emit("data:ready", e)
            }
            )).catch((e => {
        ...
        async function Kt(e, t, o, i) {
            (await D(e, t, o, i)).close()
        }
    }
}]);
