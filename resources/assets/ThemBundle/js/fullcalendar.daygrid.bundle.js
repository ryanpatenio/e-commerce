"use strict";
(self.webpackChunkdashly = self.webpackChunkdashly || []).push([[580], {
    2639: (e, t, n) => {
        n.d(t, {
            kgr: () => Xe,
            H6J: () => cr,
        ...
        function Ee(e, t) {
            ...
            return "string" == typeof e ? function(e) {
                ...
                return null
            }(e) : "object" == typeof e && e ? we(e) : "number" == typeof e ? we(((n = {})[t || "milliseconds"] = e,
            n)) : null
        }
        function we(e) {
            var t = {
          ...
          , Le = function() {
            function e(e) {
                ...
                for (var o in e)
                    ...
                    o in ze && (r = Math.max(ze[o], r)));
                this.standardDateProps = t,
                this.extendedSettings = n,
                this.severity = r,
                this.buildFormattingFunc = He(Qe)
            }
            ...
            : function(e, t, n) {
                ...
                return function(r) {
                    ...
                    return function(e, t, n, r, o) {
                        ...
                        r.omitCommas && (e = e.replace(_e, "").trim());
        ...
        function Ye(e) {
            return "object" == typeof e && e ? new Le(e) : "string" == typeof e ? new je(e) : "function" == typeof e ? new Ge(e) : null
        }
        var Je = {
            navLinkDayClick: it,
            navLinkWeekClick: it,
        ...
        function Pt(e, t, n, r) {
            ...
            for (var m in o)
                for (var y = 0, b = xt(o[m], n); y < b.length; y++) {
                    var A, E = b[y];
                    p = c[(A = a[m]).defId];
                    s.push({
                        def: A,
            ...
            for (var u in i)
                for (var w = 0, D = xt(i[u], n); w < D.length; w++) {
                    E = D[w];
                    s.push({
                        def: e.defs[u],
                        ui: c[u],
        ...
        function qt(e, t, n, r, o, i, a) {
            ...
            var p = f.range.start
              ...
              , y = X(j(h, -1)).valueOf() === X(j(g, -1)).valueOf();
        ...
        var En = function() {
            ...
            e.prototype.countDurationsBetween = function(e, t, n) {
                ...
                return n.years && null !== (r = this.diffWholeYears(e, t)) ? r / (Se(n) / 365) : n.months && null !== (r = this.diffWholeMonths(e, t)) ? r / function(e) {
                    return Se(e) / 30
                }(n) : n.days && null !== (r = J(e, t)) ? r / Se(n) : (t.valueOf() - e.valueOf()) / Te(n)
            }
            ,
        ...
        function Sn(e) {
            for (var t = e.length > 0 ? e[0].code : "en", n = wn.concat(e), r = {
                en: Cn
          ...
          , Un = function() {
            ...
            return e.prototype.splitProps = function(e) {
                ...
                for (var u in this.eventUiBuilders = ue(n, (function(e, n) {
                    return t.eventUiBuilders[n] || He(_n)
                }
                )),
                n) {
                    var d = n[u]
            ...
            e.prototype._splitInteraction = function(e) {
                ...
                if (e) {
                    var n = this._splitEventStore(e.affectedEvents, this._getKeysForEventDefs(e.affectedEvents))
                      ...
                      , i = function(r) {
                        t[r] || (t[r] = {
                            affectedEvents: n[r] || zn,
                            mutatedEvents: o[r] || zn,
                            isEvent: e.isEvent
                        })
                    };
                    for (var a in n)
        ...
        function Jn(e, t, n) {
            ...
            var r = n ? e.getBoundingClientRect() : Xn(e)
              , o = function(e, t) {
                ...
                return jn() && "rtl" === n.direction ? c.scrollbarLeft = l : c.scrollbarRight = l,
        ...
        var Tr = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.normalizeClassNames = Dr(),
                t
            }
            return (0,
            r.ZT)(t, e),
        ...
        var Mr = function() {
            ...
            e.prototype.build = function(e, t, n) {
                ...
                d.showNonCurrentDates || (s = Mt(s, o.range)),
                s = Mt(s = this.adjustActiveRange(s), r),
                l = Nt(o.range, r),
                {
                    validRange: r,
            ...
            e.prototype.buildRangeFromDuration = function(e, t, n, r) {
                ...
                return Se(n) <= 1 && this.isHiddenDay(o) && (o = X(o = this.skipHiddenDays(o, t))),
                d(),
        ...
        function Or(e, t, n, o) {
            ...
            case "FETCH_EVENT_SOURCES":
                return zr(e, t.sourceIds ? de(t.sourceIds) : _r(e, o), s, t.isRefetch || !1, o);
            case "RECEIVE_EVENTS":
                ...
                widgets: f.map((function(e) {
                    return e.split(",").map((function(e) {
                        ...
                        if (n = s[e])
                            ...
                            y = V(f.buttonTitleOverride || f.buttonTitleDefault || t.viewHint, [b, e], b)
                        } else if (i[e])
                            if (v = function() {
                                i[e]()
                            }
                            ...
                            "prevYear" === e || "nextYear" === e) {
                                ...
                                y = V(u[A] || d[A], [c.year || "year", "year"], c[e])
                            } else
                                y = function(t) {
        ...
        var oo = function() {
            function e(e) {
                ...
                this.buildLocale = He(Tn),
                this.buildPluginHooks = vr(),
                this.buildDateEnv = He(io),
                this.buildTheme = He(ao),
                this.parseToolbars = He(Gr),
                this.buildViewSpecs = He(xr),
            ...
            e.prototype._handleAction = function(e) {
                ...
                for (var p = Or(o.eventSources, e, f, u), h = Fr(o.eventStore, e, p, f, u), v = Hr(p) && !c.options.progressiveEventRendering && o.renderableEventStore || h, g = this.buildViewUiProps(u), m = g.eventUiSingleBase, y = g.selectionConfig, b = this.buildEventUiBySource(p), A = {
                    ...
                    eventResize: jr(o.eventResize, e)
                }, E = (0,
                r.pi)((0,
                r.pi)({}, u), A), w = 0, D = s.pluginHooks.reducers; w < D.length; w++) {
                    var C = D[w];
                    (0,
                    r.pi)(A, C(o, e, E))
                }
                var S = po(o, u)
                  , T = po(A, u);
                !S && T ? i.trigger("loading", !0) : S && !T && i.trigger("loading", !1),
                this.state = A,
            ...
            e.prototype.processRawCalendarOptions = function(e, t) {
                ...
                r.pi)((0,
                r.pi)((0,
                r.pi)({}, Je), Ke), $e), c.listenerRefiners), c.optionRefiners)
                  , d = {}
                  , f = rt([Xe, l, e, t])
                  , p = {}
        ...
        function so(e) {
            return new (e.dateProfileGeneratorClass || Mr)(e)
        }
        function lo(e, t, n) {
            return new ln(e,t,n)
        }
        ...
        function ho(e) {
            return In(e.options.businessHours, e)
        }
        function vo(e, t) {
            for (var n in e)
            ...
            e.prototype.findInsertion = function(e) {
                for (var t = this, n = t.levelCoords, r = t.entriesByLevel, o = t.strictOrder, i = t.stackCnts, a = n.length, s = 0, l = -1, c = -1, u = null, d = 0, f = 0; f < a; f += 1) {
                    ...
                    if (!o && p >= s + e.thickness)
                        break;
                    for (var h = r[f], v = void 0, g = wo(h, e.span.start, mo), m = g[0] + g[1]; (v = h[m]) && v.span.start < e.span.end; ) {
                        var y = p + v.thickness;
                        y > s && (s = y,
                        u = v,
                        l = f,
                ...
                if (u)
                    for (b = l + 1; b < a && n[b] < s; )
                        b += 1;
                var A = -1;
                return b < a && n[b] === s && (A = wo(r[b], e.span.end, mo)[0]),
                {
                    touchingLevel: l,
                    touchingLateral: c,
                    touchingEntry: u,
        ...
        var Io = function(e) {
          ...
          , Po = function(e) {
            function t() {
                ...
                t.buildViewPropTransformers = He(zo),
                t.buildToolbarProps = He(Bo),
                t.headerRef = s(),
                t.footerRef = s(),
                t.interactionsStore = {},
                t.state = {
                ...
                t.registerInteractiveComponent = function(e, n) {
                    var r = function(e, t) {
                      ...
                      , o = [Oo, Ho].concat(t.props.pluginHooks.componentInteractions).map((function(e) {
                        return new e(r)
                    }
                    ));
            ...
            t.prototype.render = function() {
                ...
                r.pi)({
                    ...
                    aspectRatio: e,
                    labeledById: u
                }, this.renderView(t), this.buildAppendContent()), n.footer && i(Mo, (0,
                r.pi)({
                    ref: this.footerRef,
        ...
        var Fo = function(e) {
            ...
            t.prototype.render = function() {
                var e = this.context
                  ...
                  , p = !u.isDisabled && s.colCnt > 1 ? Qn(this.context, l) : {}
                  , h = (0,
                r.pi)((0,
                r.pi)((0,
                r.pi)({
                ...
                return i(yr, {
                    ...
                    r.pi)({
                        ...
                        "data-date": u.isDisabled ? void 0 : Ie(l),
                        colSpan: s.colSpan
          ...
          , Lo = function(e) {
            ...
            t.prototype.render = function() {
                var e = this.props
                  ...
                  , u = [_o].concat(Fn(c, o), e.extraClassNames || [])
        ...
        var qo = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.createDayHeaderFormatter = He(jo),
                t
            }
            return (0,
            r.ZT)(t, e),
        ...
        var Go = function() {
          ...
          , Jo = function() {
            ...
            e.prototype._sliceInteraction = function(e, t, n, r) {
                ...
                if (!e)
                    return null;
                var a = Pt(e.mutatedEvents, t, Xo(n, Boolean(r)), r);
                return {
        ...
        function ti(e, t, n, o) {
            ...
            !(e.eventDrag && !function(e, t, n, o) {
                var i = t.getCurrentData()
                  ...
                  , l = s.defs
                  , c = s.instances
                  , u = _t(l, a.isEvent ? e.eventUiBases : {
                    "": i.selectionConfig
                });
                o && (u = ue(u, o));
                ...
                for (var m in c) {
                    ...
                    for (var C in p) {
                        ...
                        if (Nt(b, S.range)) {
                            ...
                            if (!1 === A.overlap)
                                return !1;
                            if (D && !D(new hn(t,f[S.defId],S), new hn(t,E,y)))
                                return !1
                        }
                    }
                    for (var T = i.eventStore, R = 0, k = A.allows; R < k.length; R++) {
                        var x = k[R]
                          , I = (0,
                        r.pi)((0,
                        r.pi)({}, n), {
                          ...
                          , N = T.instances[m]
                          , O = void 0;
                        if (O = M ? new hn(t,M,N) : new hn(t,E),
                        !x(nn(I, t), O))
                            return !1
                    }
                }
        ...
        var bi = function(e) {
            ...
            t.prototype.render = function() {
                var e = this.props
                  ...
                  , s = {
                    ...
                    isDraggable: !e.disableDragging && Lt(r, t),
            ...
            ,
            t.prototype.componentDidMount = function() {
                zt(this.elRef.current, this.props.seg)
            }
            ,
            t.prototype.componentDidUpdate = function(e) {
                var t = this.props.seg;
                t !== e.seg && zt(this.elRef.current, t)
            }
            ,
            t
        }(cr)
        ...
        function Si(e) {
            ...
            r.pi)({
                ...
                dayNumberText: e.showDayNumber ? n.format(t, Di) : ""
            }), e.extraProps)
        }
        var Ti = function(e) {
            function t() {
            ...
            t.prototype.render = function() {
                var e = this.props
                  ...
                  , o = Fn(r, t.theme).concat(r.isDisabled ? [] : this.normalizeClassNames(n.dayCellClassNames, r))
                  , a = r.isDisabled ? {} : {
                    "data-date": Ie(e.date)
                };
                return i(wr, {
        ...
        function Bi(e) {
            ...
            return {
                ...
                t.reduce(_i).eventRange.range.end)
            }
        }
        function zi(e) {
        ...
        function A(e, t, n, r, o, i, a) {
            ...
            for (var f = s.addSegs(l), p = function(e, t, n) {
                for (var r = function(e, t) {
                    ...
                    for (var g = 0, m = l; g < m.length; g++) {
                        ...
                        b ? (d += y.thickness,
                        A && v.push({
                            seg: E(h, y.span.start, y.span.end, n),
                            isVisible: !0,
                            isAbsolute: !0,
                            absoluteTop: y.levelCoord,
                            marginTop: 0
            ...
            for (var C = 0, S = f; C < S.length; C++) {
                var T = S[C]
                  ...
                  , k = T.span;
                v[k.start].push({
                    seg: E(R, k.start, k.end, a),
                    isVisible: !1,
                    isAbsolute: !0,
                    absoluteTop: 0,
                    marginTop: 0
                });
                for (D = k.start; D < k.end; D += 1)
                    m[D] += 1,
                    h[D].push({
                        seg: E(R, D, D + 1, a),
                        isVisible: !1,
            ...
            t.prototype.renderFgSegs = function(e, t, n, i, a, s, l) {
                ...
                if (d)
                    for (var y = 0, b = t; y < b.length; y++) {
                        var A = b[y]
                          , E = A.seg
                          , w = E.eventRange.instance.instanceId
                          , D = w + ":" + e
                          , C = A.isVisible && !i[w]
                          , S = A.isAbsolute
                          , T = ""
                          , R = "";
                        S && (c.isRtl ? (R = 0,
                        T = d.lefts[E.lastCol] - d.lefts[E.firstCol]) : (T = 0,
                        R = d.rights[E.firstCol] - d.rights[E.lastCol])),
                        m.push((0,
                        r.azq)("div", {
