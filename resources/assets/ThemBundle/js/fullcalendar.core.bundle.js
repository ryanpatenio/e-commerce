"use strict";
(self.webpackChunkdashly = self.webpackChunkdashly || []).push([[773], {
    2639: (e, t, n) => {
        n.d(t, {
            kgr: () => Xe,
            H6J: () => ur,
        ...
        var S = ["webkitTransitionEnd", "otransitionend", "oTransitionEnd", "msTransitionEnd", "transitionend"];
        function T(e, t) {
            var n = function(r) {
                t(r),
        ...
        function N(e) {
            ...
            e.addEventListener("selectstart", D)
        }
        function B(e) {
        ...
        function me(e, t, n) {
            ...
            a) {
                ...
                if (u.recurringDef) {
                    ...
                    for (var d = 0, f = ye(u, c, t, r, o.recurringTypes); d < f.length; d++) {
                        var p = f[d]
                          , h = ae(l, {
                            start: p,
                            end: r.add(p, c)
        ...
        function _e(e, t) {
            ...
            return "string" == typeof e ? function(e) {
                ...
                return null
            }(e) : "object" == typeof e && e ? Ee(e) : "number" == typeof e ? Ee(((n = {})[t || "milliseconds"] = e,
            n)) : null
        }
        function Ee(e) {
            var t = {
        ...
        function Re(e, t, n) {
            ...
            r.length > 10 && (null == t ? r = r.replace("Z", "") : 0 !== t && (r = r.replace("Z", Me(t, !0)))),
            r
        }
        function xe(e) {
        ...
        function Ie(e) {
            return z(e.getUTCHours(), 2) + ":" + z(e.getUTCMinutes(), 2) + ":" + z(e.getUTCSeconds(), 2)
        }
        function Me(e, t) {
            void 0 === t && (t = !1);
            var n = e < 0 ? "-" : "+"
              ...
              , o = Math.floor(r / 60)
              , i = Math.round(r % 60);
            return t ? n + z(o, 2) + ":" + z(i, 2) : "GMT" + n + o + (i ? ":" + z(i, 2) : "")
        }
        function Oe(e, t, n) {
            if (e === t)
                return !0;
        ...
        var Pe = {
          ...
          , We = function() {
            function e(e) {
                ...
                for (var o in e)
                    o in Pe ? (n[o] = e[o],
                    r = Math.max(Pe[o], r)) : (t[o] = e[o],
                    o in He && (r = Math.max(He[o], r)));
                this.standardDateProps = t,
                this.extendedSettings = n,
                this.severity = r,
                this.buildFormattingFunc = Ne(Qe)
            }
            ...
            e.prototype.formatRange = function(e, t, n, r) {
                ...
                if (l === u)
                    return l;
                var c = Qe(function(e, t) {
                    var n = {};
                    for (var r in e)
                        (!(r in He) || He[r] <= t) && (n[r] = e[r]);
                    return n
                }(o, s), i, n)
                  , d = c(e)
                  , f = c(t)
                ...
                return function(r) {
                    ...
                    return function(e, t, n, r, o) {
                        ...
                        "short" === n.timeZoneName && (e = function(e, t) {
                            ...
                            n || (e += " " + t);
                            return e
                        }(e, "UTC" === o.timeZone || null == t.timeZoneOffset ? "UTC" : Me(t.timeZoneOffset)));
                        r.omitCommas && (e = e.replace(ze, "").trim());
        ...
        function qe(e) {
            return "object" == typeof e && e ? new We(e) : "string" == typeof e ? new Ge(e) : "function" == typeof e ? new Ye(e) : null
        }
        var Je = {
            navLinkDayClick: it,
            navLinkWeekClick: it,
            ...
            buttonIcons: it,
            customButtons: it,
            defaultAllDayEventDuration: _e,
            defaultTimedEventDuration: _e,
            nextDayThreshold: _e,
            scrollTime: _e,
        ...
        function _t(e, t, n, r, o) {
            ...
            if (u)
                return (c = Dt(a, s, t ? t.sourceId : "", u.allDay, Boolean(u.duration), n)).recurringDef = {
                    typeId: u.typeId,
                    typeData: u.typeData,
                    duration: u.duration
                },
            ...
            return d ? {
                def: c = Dt(a, s, t ? t.sourceId : "", d.allDay, d.hasEnd, n),
                instance: ae(c.defId, d.range, d.forcedStartTzo, d.forcedEndTzo)
            } : null
        }
        function Et(e, t, n) {
        ...
        function kt(e, t, n, r) {
            return "year" === r ? _e(n.diffWholeYears(e, t), "year") : "month" === r ? _e(n.diffWholeMonths(e, t), "month") : (i = t,
            a = X(o = e),
            s = X(i),
            {
                years: 0,
        ...
        function Bt(e, t, n, r) {
            var o = {}
              ...
              , u = zt(e.defs, t);
            for (var c in e.defs) {
                "inverse-background" === (p = u[(A = e.defs[c]).defId]).display && (A.groupId ? (o[A.groupId] = [],
                a[A.groupId] || (a[A.groupId] = A)) : i[c] = [])
            }
            for (var d in e.instances) {
                var f = e.instances[d]
                  , p = u[(A = e.defs[f.defId]).defId]
                  , h = f.range
                  , v = !A.allDay && r ? St(h, r) : h
                  , g = It(v, n);
            ...
            for (var m in o)
                for (var y = 0, b = Rt(o[m], n); y < b.length; y++) {
                    var A, _ = b[y];
                    p = u[(A = a[m]).defId];
                    s.push({
                        def: A,
            ...
            for (var c in i)
                for (var E = 0, w = Rt(i[c], n); E < w.length; E++) {
                    _ = w[E];
                    s.push({
                        def: e.defs[c],
                        ui: u[c],
        ...
        function jt(e, t, n, r, o, i, a) {
            ...
            var p = f.range.start
              ...
              , m = X(p).valueOf() === X(v).valueOf()
              , y = X(G(h, -1)).valueOf() === X(G(g, -1)).valueOf();
            return u && !d.allDay && (m || y) ? (v = m ? p : v,
            g = y ? h : g,
        ...
        function on(e, t, n, r) {
            ...
            for (var l in e.instances) {
                var u = e.instances[l];
                s = i.defs[u.defId];
                i.instances[l] = sn(u, s, o[u.defId], n, r)
            }
            return i
        }
        function an(e, t, n, o) {
        ...
        function sn(e, t, n, o, i) {
            ...
            l && (u.range = {
                start: u.range.start,
                end: rn(t.allDay, u.range.start, i)
            }),
            t.allDay && (u.range = {
                start: X(u.range.start),
                end: X(u.range.end)
            }),
            u.range.end < u.range.start && (u.range.end = rn(t.allDay, u.range.start, i)),
            u
        }
        var ln = function() {
            function e(e, t, n) {
        ...
        function dn(e) {
            ...
            r.pi)((0,
            r.pi)((0,
            r.pi)({}, pt), un), e.pluginHooks.eventSourceRefiners)
        }
        function fn(e, t) {
          ...
          , hn = function() {
            ...
            e.prototype.setDates = function(e, t, n) {
                ...
                if (l && ((null == t || (r = a.createMarker(t))) && this._instance)) {
                    ...
                    !0 === n.allDay && (u = Ct(u));
                    var c = kt(u.start, l, a, n.granularity);
                    if (r) {
                        var d = kt(u.end, r, a, n.granularity);
                        i = d,
        ...
        function gn(e, t, n) {
            ...
            for (var s in o) {
                var l = o[s]
                  , u = r[l.defId];
                l.instanceId !== a && i.push(new hn(t,u,l))
            }
            return i
        }
        var mn = {};
        ...
        var _n = function() {
            ...
            e.prototype.countDurationsBetween = function(e, t, n) {
                ...
                return n.years && null !== (r = this.diffWholeYears(e, t)) ? r / (Ce(n) / 365) : n.months && null !== (r = this.diffWholeMonths(e, t)) ? r / function(e) {
                    return Ce(e) / 30
                }(n) : n.days && null !== (r = J(e, t)) ? r / Ce(n) : (t.valueOf() - e.valueOf()) / Se(n)
            }
            ,
        ...
        function Cn(e) {
            for (var t = e.length > 0 ? e[0].code : "en", n = En.concat(e), r = {
                en: Dn
        ...
        var Hn = {
          ...
          , Un = function() {
            function e() {
                this.getKeysForEventDefs = Ne(this._getKeysForEventDefs),
                this.splitDateSelection = Ne(this._splitDateSpan),
                this.splitEventStore = Ne(this._splitEventStore),
                this.splitIndividualUi = Ne(this._splitIndividualUi),
                this.splitEventDrag = Ne(this._splitInteraction),
                this.splitEventResize = Ne(this._splitInteraction),
            ...
            return e.prototype.splitProps = function(e) {
                var t = this
                  ...
                  , u = {};
                for (var c in this.eventUiBuilders = ce(n, (function(e, n) {
                    return t.eventUiBuilders[n] || Ne(zn)
                }
                )),
                n) {
                    var d = n[c]
            ...
            e.prototype._splitInteraction = function(e) {
                ...
                if (e) {
                    var n = this._splitEventStore(e.affectedEvents, this._getKeysForEventDefs(e.affectedEvents))
                      ...
                      , i = function(r) {
                        t[r] || (t[r] = {
                            affectedEvents: n[r] || Hn,
                            mutatedEvents: o[r] || Hn,
                            isEvent: e.isEvent
                        })
                    };
                    for (var a in n)
        ...
        function Fn(e, t, n, r) {
            return {
                dow: e.getUTCDay(),
                isDisabled: Boolean(r && !Nt(r.activeRange, e)),
                isOther: Boolean(r && !Nt(r.currentRange, e)),
                isToday: Boolean(t && Nt(t, e)),
        ...
        function Jn(e, t, n) {
            ...
            var r = n ? e.getBoundingClientRect() : Xn(e)
              , o = function(e, t) {
                ...
                return Gn() && "rtl" === n.direction ? u.scrollbarLeft = l : u.scrollbarRight = l,
        ...
        var ir = function() {
          ...
          , ar = u({});
        function sr(e, t, n, r, o, i, a, s, l, u, c, d, f) {
            return {
                dateEnv: o,
                options: n,
                pluginHooks: a,
                ...
                createScrollResponder: function(e) {
                    return new ir(e,u,_e(n.scrollTime),n.scrollTimeReset)
                },
        ...
        function vr() {
            var e, t = [], n = [];
            return function(o, i) {
                return e && Oe(o, t) && Oe(i, n) || (e = function(e, t) {
                    var n = {}
                      , o = {
                        reducers: [],
                        isLoadingFuncs: [],
                    ...
                    function i(e) {
                        for (var t = 0, a = e; t < a.length; t++) {
                            ...
                            o = {
                                ...
                                themeClasses: (0,
                                r.pi)((0,
                                r.pi)({}, l.themeClasses), u.themeClasses),
                                ...
                                r.pi)((0,
                                r.pi)({}, l.optionChangeHandlers), u.optionChangeHandlers),
                                scrollGridImpl: u.scrollGridImpl || l.scrollGridImpl,
                                contentTypeHandlers: (0,
                                r.pi)((0,
                                r.pi)({}, l.contentTypeHandlers), u.contentTypeHandlers),
                                listenerRefiners: (0,
                                r.pi)((0,
                                r.pi)({}, l.listenerRefiners), u.listenerRefiners),
                                optionRefiners: (0,
                                r.pi)((0,
                                r.pi)({}, l.optionRefiners), u.optionRefiners),
                                propSetHandlers: (0,
                                r.pi)((0,
                                r.pi)({}, l.propSetHandlers), u.propSetHandlers)
                            })
                        }
                        var l, u
                    }
        ...
        function mr(e, t, n, o) {
            ...
            var i = function(e, t, n, o) {
                ...
                return {
                    ...
                    defaults: (0,
                    r.pi)((0,
                    r.pi)({}, c ? c.defaults : {}), i ? i.rawOptions : {}),
                    overrides: (0,
                    r.pi)((0,
                    r.pi)({}, c ? c.overrides : {}), a ? a.rawOptions : {})
                }
            }(e, t, n, o);
            return i && (t[e] = i),
            i
            ...
            t.prototype.render = function() {
                ...
                return i(Er, {
                    ...
                    return i(Ar, {
                        ...
                        return t.children(r, Dr(t.classNames, n), e, o)
                    }
                    ))
                }
                ))
            ...
            return ce(s, (function(e) {
                return function(e, t, n, o, i) {
                    ...
                    return {
                        ...
                        buttonTextDefault: f(i) || e.defaults.buttonText || f(Xe) || e.type,
                        buttonTitleOverride: p(o) || p(n) || e.overrides.buttonHint,
                        buttonTitleDefault: p(i) || e.defaults.buttonHint || p(Xe)
                    }
                }(e, a, t, n, o)
            }
            ))
        ...
        var Ir = function() {
            ...
            e.prototype.buildRangeFromDuration = function(e, t, n, r) {
                ...
                return Ce(n) <= 1 && this.isHiddenDay(o) && (o = X(o = this.skipHiddenDays(o, t))),
                d(),
            ...
            e.prototype.buildDateIncrement = function(e) {
                ...
                return n || ((t = this.props.dateAlignment) ? _e(1, t) : e || _e({
                    days: 1
                }))
            }
            ,
        ...
        function Or(e, t, n, o) {
            ...
            case "FETCH_EVENT_SOURCES":
                return Hr(e, t.sourceIds ? de(t.sourceIds) : zr(e, o), s, t.isRefetch || !1, o);
            case "RECEIVE_EVENTS":
                ...
                widgets: f.map((function(e) {
                    return e.split(",").map((function(e) {
                        ...
                        if (n = s[e])
                            ...
                            y = F(f.buttonTitleOverride || f.buttonTitleDefault || t.viewHint, [b, e], b)
                        } else if (i[e])
                            if (v = function() {
                                i[e]()
                            }
                            ...
                            "prevYear" === e || "nextYear" === e) {
                                ...
                                y = F(c[A] || d[A], [u.year || "year", "year"], u[e])
                            } else
                                y = function(t) {
                                    return F(c[e] || d[e], [u[t] || t, t], u[e])
                                }
                                ;
                        return {
                            buttonName: e,
        ...
        var eo = [hr({
            ...
            eventSourceDefs: [{
                ...
                fetch: function(e, t, n) {
                    ...
                    Xr(o.method, o.url, i, (function(e, n) {
                        t({
                            rawEvents: e,
                            xhr: n
                        })
        ...
        var oo = function() {
            function e(e) {
                var t = this;
                this.computeOptionsData = Ne(this._computeOptionsData),
                this.computeCurrentViewData = Ne(this._computeCurrentViewData),
                this.organizeRawLocales = Ne(Cn),
                this.buildLocale = Ne(Sn),
                this.buildPluginHooks = vr(),
                this.buildDateEnv = Ne(io),
                this.buildTheme = Ne(ao),
                this.parseToolbars = Ne(Yr),
                this.buildViewSpecs = Ne(Rr),
                this.buildDateProfileGenerator = Be(so),
                this.buildViewApi = Ne(lo),
                this.buildViewUiProps = Be(fo),
                this.buildEventUiBySource = Ne(uo, pe),
                this.buildEventUiBases = Ne(co),
                this.parseContextBusinessHours = Be(ho),
                this.buildTitle = Ne(ro),
                this.emitter = new $n,
                ...
                Nt(d.activeRange, c) || (c = d.currentRange.start);
                for (var f = {
                    dateEnv: o.dateEnv,
                ...
                for (var v = Mr(o.calendarOptions, d, f), g = {
            ...
            e.prototype._handleAction = function(e) {
                ...
                var c = {
                  ...
                  , d = o.currentDate
                  , f = o.dateProfile;
                this.data && this.data.dateProfileGenerator !== u.dateProfileGenerator && (f = u.dateProfileGenerator.build(d)),
                d = function(e, t) {
                ...
                f = function(e, t, n, r) {
                    ...
                    return e
                }(f, e, d, u.dateProfileGenerator),
                "PREV" !== e.type && "NEXT" !== e.type && Nt(f.currentRange, d) || (d = f.currentRange.start);
                for (var p = Or(o.eventSources, e, f, c), h = Vr(o.eventStore, e, p, f, c), v = Nr(p) && !u.options.progressiveEventRendering && o.renderableEventStore || h, g = this.buildViewUiProps(c), m = g.eventUiSingleBase, y = g.selectionConfig, b = this.buildEventUiBySource(p), A = {
                    ...
                    dateSelection: Qr(o.dateSelection, e),
                    eventSelection: Zr(o.eventSelection, e),
                    eventDrag: jr(o.eventDrag, e),
                    eventResize: Gr(o.eventResize, e)
                }, _ = (0,
                r.pi)((0,
                r.pi)({}, c), A), E = 0, w = s.pluginHooks.reducers; E < w.length; E++) {
                    var D = w[E];
                    (0,
                    r.pi)(A, D(o, e, _))
                }
                var C = po(o, c)
                  , S = po(A, c);
                !C && S ? i.trigger("loading", !0) : C && !S && i.trigger("loading", !1),
                this.state = A,
                n.onAction && n.onAction(e)
            }
            ,
            e.prototype.updateData = function() {
                var e, t, n, o, i, a, s, l, u, c = this.props, d = this.state, f = this.data, p = this.computeOptionsData(c.optionOverrides, d.dynamicOptionOverrides, c.calendarApi), h = this.computeCurrentViewData(d.currentViewType, p, c.optionOverrides, d.dynamicOptionOverrides), v = this.data = (0,
                r.pi)((0,
                r.pi)((0,
                r.pi)({
            ...
            e.prototype.processRawCalendarOptions = function(e, t) {
                var n = rt([Xe, e, t])
                  ...
                  , u = this.buildPluginHooks(e.plugins || [], eo)
                  , c = this.currentCalendarOptionsRefiners = (0,
                r.pi)((0,
                r.pi)((0,
                r.pi)((0,
                r.pi)((0,
                r.pi)({}, Je), Ke), $e), u.listenerRefiners), u.optionRefiners)
                  , d = {}
                  , f = rt([Xe, l, e, t])
                  , p = {}
                  ...
                  , g = !1;
                for (var m in f)
                    "plugins" !== m && (f[m] === h[m] || et[m] && m in h && et[m](h[m], f[m]) ? p[m] = v[m] : c[m] ? (p[m] = c[m](f[m]),
                    g = !0) : d[m] = h[m]);
            ...
            e.prototype.processRawViewOptions = function(e, t, n, o, i) {
                var a = rt([Xe, e.optionDefaults, n, o, e.optionOverrides, i])
                  , s = (0,
                r.pi)((0,
                r.pi)((0,
                r.pi)((0,
                r.pi)((0,
                r.pi)((0,
                r.pi)({}, Je), Ke), $e), nt), t.listenerRefiners), t.optionRefiners)
                  , l = {}
                  ...
                  , f = {};
                for (var p in a)
                    a[p] === u[p] || et[p] && et[p](a[p], u[p]) ? l[p] = c[p] : (a[p] === this.currentCalendarOptionsInput[p] || et[p] && et[p](a[p], this.currentCalendarOptionsInput[p]) ? p in this.currentCalendarOptionsRefined && (l[p] = this.currentCalendarOptionsRefined[p]) : s[p] ? l[p] = s[p](a[p]) : f[p] = a[p],
                    d = !0);
        ...
        function io(e, t, n, r, o, i, a, s) {
            var l = Sn(t || a.defaultCode, a.map);
            return new _n({
        ...
        var go = function() {
            ...
            e.prototype.insertEntryAt = function(e, t) {
                var n = this.entriesByLevel
                  , r = this.levelCoords;
                -1 === t.lateral ? (_o(r, t.level, t.levelCoord),
                _o(n, t.level, [e])) : _o(n[t.level], t.lateral, e),
            ...
            e.prototype.findInsertion = function(e) {
                for (var t = this, n = t.levelCoords, r = t.entriesByLevel, o = t.strictOrder, i = t.stackCnts, a = n.length, s = 0, l = -1, u = -1, c = null, d = 0, f = 0; f < a; f += 1) {
                    ...
                    if (!o && p >= s + e.thickness)
                        break;
                    for (var h = r[f], v = void 0, g = Eo(h, e.span.start, mo), m = g[0] + g[1]; (v = h[m]) && v.span.start < e.span.end; ) {
                        var y = p + v.thickness;
                        y > s && (s = y,
                        c = v,
                        l = f,
                ...
                if (c)
                    for (b = l + 1; b < a && n[b] < s; )
                        b += 1;
                var A = -1;
                return b < a && n[b] === s && (A = Eo(r[b], e.span.end, mo)[0]),
                {
                    touchingLevel: l,
                    touchingLateral: u,
                    touchingEntry: c,
        ...
        var xo = function(e) {
          ...
          , Bo = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.buildViewContext = Ne(sr),
                t.buildViewPropTransformers = Ne(Ho),
                t.buildToolbarProps = Ne(Po),
                t.headerRef = s(),
                t.footerRef = s(),
                t.interactionsStore = {},
                t.state = {
                ...
                t.registerInteractiveComponent = function(e, n) {
                    var r = function(e, t) {
                      ...
                      , o = [Oo, No].concat(t.props.pluginHooks.componentInteractions).map((function(e) {
                        return new e(r)
                    }
                    ));
        ...
        function Po(e, t, n, r, o, i) {
            ...
            return {
                ...
                isTodayEnabled: a.isValid && !Nt(t.currentRange, o),
        ...
        var Uo = function(e) {
            ...
            t.prototype.render = function() {
                ...
                return Pn() || i.push("fc-liquid-hack"),
                e.children(i, o, r, n)
            }
            ,
            t.prototype.componentDidMount = function() {
        ...
        var Vo = function(e) {
            ...
            t.prototype.render = function() {
                var e = this.context
                  ...
                  , l = s.date
                  , u = s.dateProfile
                  , c = Fn(l, s.todayRange, null, u)
                  , d = [zo].concat(Vn(c, o))
                  , f = t.format(l, s.dayHeaderFormat)
                  , p = !c.isDisabled && s.colCnt > 1 ? Qn(this.context, l) : {}
                  , h = (0,
                r.pi)((0,
                r.pi)((0,
                r.pi)({
                ...
                return i(yr, {
                    ...
                    r.pi)({
                        ...
                        "data-date": c.isDisabled ? void 0 : xe(l),
                        colSpan: s.colSpan
          ...
          , Wo = function(e) {
            ...
            t.prototype.render = function() {
                var e = this.props
                  ...
                  , c = [zo].concat(Vn(u, o), e.extraClassNames || [])
        ...
        var jo = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.createDayHeaderFormatter = Ne(Go),
                t
            }
            return (0,
            r.ZT)(t, e),
        ...
        var Yo = function() {
          ...
          , Jo = function() {
            function e() {
                this.sliceBusinessHours = Ne(this._sliceBusinessHours),
                this.sliceDateSelection = Ne(this._sliceDateSpan),
                this.sliceEventStore = Ne(this._sliceEventStore),
            ...
            e.prototype._sliceBusinessHours = function(e, t, n, o) {
                ...
                r.ev)([me(e, Xo(t, Boolean(n)), o), {}, t, n], i)).bg : []
            }
            ,
            ...
            e.prototype._sliceInteraction = function(e, t, n, r) {
                ...
                if (!e)
                    return null;
                var a = Bt(e.mutatedEvents, t, Xo(n, Boolean(r)), r);
                return {
            ...
            e.prototype._sliceDateSpan = function(e, t, n) {
                ...
                for (var a = function(e, t, n) {
                    var r = Et({
                      ...
                      , o = Dt(r.refined, r.extra, "", e.allDay, !0, n);
                    return {
                        def: o,
                        ui: Ft(o, t),
                ...
                r.ev)([e.range], o)), l = 0, u = s; l < u.length; l++) {
                    u[l].eventRange = a
                }
                return s
            }
        ...
        function $o(e, t, n) {
            return !!Ot(t.validRange, e.range) && ei({
                dateSelection: e
            }, n)
        }
        function ei(e, t) {
        ...
        function ti(e, t, n, o) {
            ...
            !(e.eventDrag && !function(e, t, n, o) {
                var i = t.getCurrentData()
                  ...
                  , l = s.defs
                  , u = s.instances
                  , c = zt(l, a.isEvent ? e.eventUiBases : {
                    "": i.selectionConfig
                });
                o && (c = ce(c, o));
                ...
                {
                    defs: v.defs,
                    instances: ue(v.instances, (function(e) {
                ...
                for (var m in u) {
                    ...
                    for (var D in p) {
                        ...
                        if (Mt(b, C.range)) {
                            ...
                            if (!1 === A.overlap)
                                return !1;
                            if (w && !w(new hn(t,f[C.defId],C), new hn(t,_,y)))
                                return !1
                        }
                    }
                    for (var S = i.eventStore, T = 0, k = A.allows; T < k.length; T++) {
                        ...
                        r.pi)({}, n), {
                          ...
                          , M = S.instances[m]
                          , O = void 0;
                        if (O = I ? new hn(t,I,M) : new hn(t,_),
                        !R(nn(x, t), O))
                            return !1
                    }
                }
                ...
                o && (c = o(c));
                if (!ni(c.constraints, u, i, e.businessHours, t))
                    return !1;
        ...
        function fi(e, t) {
            for (var n = [], o = 0, a = e; o < a.length; o++)
                for (var s = a[o], l = s.span || 1, u = 0; u < l; u += 1)
                    n.push(i("col", {
                        style: {
        ...
        var yi = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.processCols = Ne((function(e) {
                    return e
                }
                ), di),
                t.renderMicroColGroup = Ne(fi),
            ...
            t.prototype.render = function() {
                ...
                for (var c, d = a.length, f = 0, p = [], h = [], v = []; f < d && "header" === (c = a[f]).type; )
                    p.push(this.renderSection(c, l, !0)),
                    f += 1;
                for (; f < d && "body" === (c = a[f]).type; )
                    h.push(this.renderSection(c, l, !1)),
                    f += 1;
                for (; f < d && "footer" === (c = a[f]).type; )
                    v.push(this.renderSection(c, l, !0)),
                    f += 1;
                var g = !Pn()
                  , m = {
                    role: "rowgroup"
            ...
            t.prototype.renderChunkTd = function(e, t, n, r) {
                ...
                var o = this.props
                  ...
                  , c = function(e, t) {
                    return null != t.maxHeight || ci(e, t)
                }(o, e)
                  , d = ci(o, e)
                ...
                return function(e) {
                    for (var t = 0, n = e; t < n.length; t++)
                        if ("shrink" === n[t].width)
                            return !0;
                    return !1
                }(this.props.cols) ? ui(this.scrollerElRefs.getAll()) : 0
            }
            ,
        ...
        var bi = function(e) {
            ...
            t.prototype.render = function() {
                var e = this.props
                  ...
                  , s = {
                    ...
                    isStartResizable: !e.disableResizing && Qt(r, t),
            ...
            ,
            t.prototype.componentDidMount = function() {
                Ht(this.elRef.current, this.props.seg)
            }
            ,
            t.prototype.componentDidUpdate = function(e) {
                var t = this.props.seg;
                t !== e.seg && Ht(this.elRef.current, t)
            }
            ,
            t
        }(ur)
          , Ai = function(e) {
            ...
            t.prototype.render = function() {
                var e = this.props
                  ...
                  , a = jt(n, o, t, e.defaultDisplayEventTime, e.defaultDisplayEventEnd);
                return i(bi, {
                    seg: n,
                    timeText: a,
                    disableDragging: e.disableDragging,
                    disableResizing: e.disableResizing,
                    defaultContent: e.defaultContent || _i,
        ...
        function Ci(e) {
            var t = e.date
              , n = e.dateEnv
              , o = Fn(t, e.todayRange, null, e.dateProfile);
            return (0,
            r.pi)((0,
            r.pi)((0,
            r.pi)({
        ...
        var Si = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.refineHookProps = Be(Ci),
                ...
                var e = this.context.isRtl
                  ...
                  , i = function(e) {
                    for (var t = Kn(e), n = e.getBoundingClientRect(), r = 0, o = t; r < o.length; r++) {
                        var i = Mn(n, o[r].getBoundingClientRect());
                        if (!i)
                            return null;
                        n = i
                    }
            ...
            t.prototype.render = function() {
                ...
                return i(ar.Consumer, null, (function(r) {
                    ...
                    return i(l, null, Boolean(t.moreCnt) && i(yr, {
                        ...
                        defaultContent: t.defaultContent || Bi,
        ...
        function Pi(e) {
            ...
            return {
                ...
                t.reduce(zi).eventRange.range.end)
            }
        }
        function Hi(e) {
    ...
    9665: (e, t, n) => {
        ...
        var r, o, i, a, s, l, u, c, d = n(7582), f = {}, p = [], h = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
        function v(e, t) {
            for (var n in t)
                e[n] = t[n];
            return e
        ...
        function E(e, t, n, r, o) {
            ...
            e: if ("style" === t)
                ...
                e.l || (e.l = {}),
                e.l[t + i] = n,
                n ? r || e.addEventListener(t, i ? D : w, i) : e.removeEventListener(t, i ? D : w, i);
        ...
        function R(e) {
            (!e.__d && (e.__d = !0) && s.push(e) && !x.__r++ || l !== o.debounceRendering) && ((l = o.debounceRendering) || k)(x)
        }
        function x() {
            var e, t, n, r, o, i, a, l;
            for (s.sort((function(e, t) {
                ...
                (l = n.__P) && (r = [],
                (o = v({}, i)).__v = i.__v + 1,
                P(l, i, o, n.__n, void 0 !== l.ownerSVGElement, null != i.__h ? [a] : null, r, null == a ? S(i) : a, i.__h),
                H(r, i),
                i.__e != a && T(i)),
                s.length > t && s.sort((function(e, t) {
                    return e.__v.__b - t.__v.__b
                }
                )));
            x.__r = 0
        ...
        function I(e, t, n, r, o, i, a, s, l, u) {
            var c, d, h, v, g, m, b, _ = r && r.__k || p, E = _.length;
            for (n.__k = [],
            c = 0; c < t.length; c++)
                if (null != (v = n.__k[c] = null == (v = t[c]) || "boolean" == typeof v ? null : "string" == typeof v || "number" == typeof v || "bigint" == typeof v ? y(null, v, null, null, v) : Array.isArray(v) ? y(A, {
                    children: v
                }, null, null, null) : v.__b > 0 ? y(v.type, v.props, v.key, v.ref ? v.ref : null, v.__v) : v)) {
                    if (v.__ = n,
                    v.__b = n.__b + 1,
                    null === (h = _[c]) || h && v.key == h.key && v.type === h.type)
                        _[c] = void 0;
                    else
                        for (d = 0; d < E; d++) {
                            if ((h = _[d]) && v.key == h.key && v.type === h.type) {
                                _[d] = void 0;
                                break
                            }
                            h = null
                        }
                    P(e, v, h = h || f, o, i, a, s, l, u),
                    g = v.__e,
                    (d = v.ref) && h.ref != d && (b || (b = []),
                    h.ref && b.push(h.ref, null, v),
                    b.push(d, v.__c || g, v)),
                    null != g ? (null == m && (m = g),
                    "function" == typeof v.type && v.__k === h.__k ? v.__d = l = M(v, l, e) : l = N(e, v, h, _, g, l),
                    "function" == typeof n.type && (n.__d = l)) : l && h.__e == l && l.parentNode != e && (l = S(h))
                }
            for (n.__e = m,
            c = E; c--; )
                null != _[c] && ("function" == typeof n.type && null != _[c].__e && _[c].__e == n.__d && (n.__d = B(r).nextSibling),
                F(_[c], _[c]));
            if (b)
        ...
        function M(e, t, n) {
            for (var r, o = e.__k, i = 0; o && i < o.length; i++)
                (r = o[i]) && (r.__ = e,
                t = "function" == typeof r.type ? M(r, t, n) : N(n, r, r, o, r.__e, t));
            return t
        }
        function O(e, t) {
            return t = t || [],
        ...
        function P(e, t, n, r, i, a, s, l, u) {
            var c, d, f, p, h, g, m, y, b, _, E, w, D, S, T, k = t.type;
            ...
            try {
                e: if ("function" == typeof k) {
                    if (y = t.props,
                    b = (c = k.contextType) && r[c.__c],
                    _ = c ? b ? b.props.value : c.__ : r,
                    n.__c ? m = (d = t.__c = n.__c).__ = d.__E : ("prototype"in k && k.prototype.render ? t.__c = d = new k(y,_) : (t.__c = d = new C(y,_),
                    d.constructor = k,
                    d.render = V),
                    b && b.sub(d),
                    d.props = y,
                    ...
                    null != k.getDerivedStateFromProps && (d.__s == d.state && (d.__s = v({}, d.__s)),
                    v(d.__s, k.getDerivedStateFromProps(y, d.__s))),
                    p = d.props,
                    h = d.state,
                    d.__v = t,
                    f)
                        ...
                        if (null == k.getDerivedStateFromProps && y !== p && null != d.componentWillReceiveProps && d.componentWillReceiveProps(y, _),
                        !d.__e && null != d.shouldComponentUpdate && !1 === d.shouldComponentUpdate(y, d.__s, _) || t.__v === n.__v) {
                        ...
                        null != d.componentWillUpdate && d.componentWillUpdate(y, d.__s, _),
                        null != d.componentDidUpdate && d.__h.push((function() {
                            d.componentDidUpdate(p, h, g)
                        }
                        ))
                    }
                    if (d.context = _,
                    ...
                    f || null == d.getSnapshotBeforeUpdate || (g = d.getSnapshotBeforeUpdate(p, h)),
                    T = null != c && c.type === A && null == c.key ? c.props.children : c,
                    I(e, Array.isArray(T) ? T : [T], t, n, r, i, a, s, l, u),
                    d.base = t.__e,
                    t.__h = null,
                    d.__h.length && s.push(d),
                    m && (d.__E = d.__ = null),
                    ...
                    t.__e = n.__e) : t.__e = U(n.__e, t, n, r, i, a, s, u);
                (c = o.diffed) && c(t)
            } catch (e) {
                t.__v = null,
                (u || null != a) && (t.__e = l,
        ...
        function U(e, t, n, o, i, a, s, l) {
            var u, c, d, p = n.props, h = t.props, v = t.type, m = 0;
            if ("svg" === v && (i = !0),
            null != a)
                for (; m < a.length; m++)
                    if ((u = a[m]) && "setAttribute"in u == !!v && (v ? u.localName === v : 3 === u.nodeType)) {
                        e = u,
                        a[m] = null;
                        break
                    }
            if (null == e) {
                ...
                e = i ? document.createElementNS("http://www.w3.org/2000/svg", v) : document.createElement(v, h.is && h),
                a = null,
                l = !1
            }
            if (null === v)
                ...
                if (function(e, t, n, r, o) {
                    var i;
                    for (i in n)
                        "children" === i || "key" === i || i in t || E(e, i, null, n[i], r);
                    for (i in t)
                        o && "function" != typeof t[i] || "children" === i || "key" === i || "value" === i || "checked" === i || n[i] === t[i] || E(e, i, t[i], n[i], r)
                }(e, h, p, i, l),
                d)
                    t.__k = [];
                else if (m = t.props.children,
                I(e, Array.isArray(m) ? m : [m], t, n, o, i && "foreignObject" !== v, a, s, a ? a[0] : n.__k && S(n, 0), l),
                null != a)
                    for (m = a.length; m--; )
                        null != a[m] && g(a[m]);
                l || ("value"in h && void 0 !== (m = h.value) && (m !== e.value || "progress" === v && !m || "option" === v && m !== p.value) && E(e, "value", m, p.value, !1),
                "checked"in h && void 0 !== (m = h.checked) && m !== e.checked && E(e, "checked", m, p.checked, !1))
            }
            return e
        }
        function z(e, t, n) {
        ...
        function F(e, t, n) {
            ...
            if (r = e.__k)
                for (i = 0; i < r.length; i++)
                    r[i] && F(r[i], t, n || "function" != typeof e.type);
        ...
        function L(e, t, n) {
            ...
            s = [],
            P(t, e = (!i && n || t).__k = m(A, null, [e]), a || f, f, void 0 !== t.ownerSVGElement, !i && n ? [n] : a ? null : t.firstChild ? r.call(t.childNodes) : null, s, !i && n ? n : a ? a.__e : t.firstChild, i),
            H(s, e)
        }
        function W(e, t) {
            var n = {
        ...
        C.prototype.setState = function(e, t) {
            var n;
            n = null != this.__s && this.__s !== this.state ? this.__s : this.__s = v({}, this.state),
        ...
        x.__r = 0,
        c = 0;
        var Q, Z, j, G = [], Y = [], q = o.__b, J = o.__r, X = o.diffed, K = o.__c, $ = o.unmount;
        function ee() {
            for (var e; e = G.shift(); )
                if (e.__P && e.__H)
                    try {
                        e.__H.__h.forEach(re),
                        e.__H.__h.forEach(oe),
                        e.__H.__h = []
                    } catch (t) {
                        e.__H.__h = [],
                        o.__e(t, e.__v)
        ...
        o.diffed = function(e) {
            X && X(e);
            var t = e.__c;
            t && t.__H && (t.__H.__h.length && (1 !== G.push(t) && j === o.requestAnimationFrame || ((j = o.requestAnimationFrame) || ne)(ee)),
        ...
        (se.prototype = new C).isPureReactComponent = !0,
        ...
        function de(e, t, n) {
            ...
            e.__c.__H = null),
            null != (e = ie({}, e)).__c && (e.__c.__P === n && (e.__c.__P = t),
            e.__c = null),
        ...
        ,
        (pe.prototype = new C).__c = function(e, t) {
            var n = t.__c
              , r = this;
            null == r.t && (r.t = []),
            r.t.push(n);
        ...
        pe.prototype.render = function(e, t) {
            ...
            var o = t.__a && m(A, null, e.fallback);
            return o && (o.__h = null),
            [m(A, null, t.__a ? null : e.children), o]
        }
        ;
        ...
        (ve.prototype = new C).__a = function(e) {
            var t = this
              , n = he(t.__v)
              , r = t.o.get(e);
            return r[0]++,
        ...
        var Ae = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.element") || 60103
          , _e = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/
        ...
        o.vnode = function(e) {
            ...
            if ("string" == typeof t) {
                ...
                n) {
                    var a = n[i];
                    Ee && "children" === i && "noscript" === t || "value" === i && "defaultValue"in n && null == a || ("defaultValue" === i && "value"in n && null == n.value ? i = "value" : "download" === i && !0 === a ? a = "" : /ondoubleclick/i.test(i) ? i = "ondblclick" : /^onchange(textarea|input)/i.test(i + t) && !we(n.type) ? i = "oninput" : /^onfocus$/i.test(i) ? i = "onfocusin" : /^onblur$/i.test(i) ? i = "onfocusout" : /^on(Ani|Tra|Tou|BeforeInp|Compo)/.test(i) ? i = i.toLowerCase() : o && _e.test(i) ? i = i.replace(/[A-Z0-9]/g, "-$&").toLowerCase() : null === a && (a = void 0),
                ...
                e.props = r,
                n.class != n.className && (ke.enumerable = "className"in n,
        ...
        ;
        var Ie = "undefined" != typeof globalThis ? globalThis : window;
        Ie.FullCalendarVDom ? console.warn("FullCalendar VDOM already loaded") : Ie.FullCalendarVDom = {
            Component: C,
            createElement: m,
            render: L,
            createRef: b,
            ...
            flushSync: function(e) {
                ...
                L(m(Me, {}), document.createElement("div"));
                for (; n.length; )
                    n.shift()();
        ...
        var Oe = n(2639)
          , Ne = function(e) {
            function t(t, n) {
                ...
                ,
                r.el = t,
                r.renderRunner = new Oe.snJ(r.handleRenderRequest),
                new Oe.FEm({
                    optionOverrides: n,
                    calendarApi: r,
            ...
            t.prototype.setClassNames = function(e) {
                if (!(0,
                Oe.CnA)(e, this.currentClassNames)) {
