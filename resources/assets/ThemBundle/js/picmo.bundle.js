"use strict";
(self.webpackChunkdashly = self.webpackChunkdashly || []).push([[416], {
    7741: (e, t, o) => {
        o.r(t),
        o.d(t, {
            EmojiPicker: () => Ft,
            ...
            LocalStorageProvider: () => je,
            NativeRenderer: () => me,
            RecentsProvider: () => fe,
            Renderer: () => he,
            SessionStorageProvider: () => Ht,
            animate: () => w,
            autoTheme: () => U,
            ...
            getEmojiForEvent: () => p,
            getOptions: () => ke,
            getPrefixedClasses: () => C,
            globalConfig: () => Le,
            i18n: () => Nt,
            isLocalStorageAvailable: () => z,
        ...
        o ? o.call(e) : t.get(e))
          ...
          , a = (e, t, o, s) => (i(e, t, "write to private field"),
        s ? s.call(e, o) : t.set(e, o),
        o)
          , n = (e, t, o) => (i(e, t, "access private method"),
        o);
        async function c(e, t={}) {
            const {local: o=!1, version: i="latest", cdnUrl: s, ...r} = t
              ...
              , n = o ? localStorage : sessionStorage
              , c = `emojibase/${i}/${e}`
              , l = n.getItem(c);
            if (l)
        ...
        async function m(e, t={}) {
            const {compact: o=!1, flat: i=!1, shortcodes: s=[], ...r} = t
              , a = await c(`${e}/${o ? "compact" : "data"}.json`, r);
            let n = [];
        ...
        class V extends F {
            ...
            getEmojis(e, t) {
                ...
                return Promise.resolve(A(o, t))
            }
            searchEmojis(e, t, o, i) {
                const s = this.emojis.filter((t => L(t, e, i) && t.version <= o)).map(P)
                  , r = t.filter((t => L(t, e, i)))
                  , a = [...A(s, o), ...r];
        ...
        async function B(e, t, o, i, s) {
            return o && i ? async function(e, t, o, i, s) {
                const r = await R(e, t, s)
                  , a = await j(i);
        ...
        const {light: O, dark: K, auto: U} = C("light", "dark", "auto");
        class W {
        ...
        class re {
            ...
            renderSync(e={}) {
                ...
                return n(this, ie, se).call(this, t, e),
                n(this, te, oe).call(this, t),
                n(this, X, ee).call(this, t, e),
                t
            }
            async renderAsync(e={}) {
                const t = b(s(this, Y).call(this, e));
                return n(this, ie, se).call(this, t, e),
                n(this, te, oe).call(this, t),
                await n(this, X, ee).call(this, t, e),
                t
            }
            render(e) {
                return "sync" === s(this, Q) ? this.renderSync(e) : this.renderAsync(e)
            }
        }
        Y = new WeakMap,
        Q = new WeakMap,
        ...
        ;
        const ae = C("imagePlaceholder", "placeholder")
        ...
        class ye extends F {
            ...
            async getEmojis(e, t) {
                ...
                return A((await this.waitForRequest(o.getAll(e.order))).target.result.filter((e => e.version <= t)).sort(( (e, t) => null != e.order && null != t.order ? e.order - t.order : 0)).map(P), t)
            }
            async searchEmojis(e, t, o, i) {
                ...
                return new Promise(( (r, a) => {
                    ...
                    n.addEventListener("success", (a => {
                        ...
                        if (!c)
                            return r([...A(s, o), ...t.filter((t => L(t, e)))]);
                        const l = c.value;
                        L(l, e, i) && l.version <= o && s.push(P(l)),
                        c.continue()
                    }
                    )),
        ...
        function ke(e={}) {
            return {
                ...
                recentsProvider: e.recentsProvider || new je
            }
        }
        var _e, xe, Ee, Se, ze;
        class Pe {
            ...
            on(e, t, o) {
                n(this, Se, ze).call(this, e, t, o)
            }
            once(e, t, o) {
                n(this, Se, ze).call(this, e, t, o, !0)
            }
            off(e, t) {
                const o = n(this, xe, Ee).call(this, e);
                s(this, _e).set(e, o.filter((e => e.handler !== t)))
            }
            emit(e, ...t) {
                n(this, xe, Ee).call(this, e).forEach((o => {
        ...
        ,
        Se = new WeakSet,
        ze = function(e, t, o, i=!1) {
            n(this, xe, Ee).call(this, e).push({
                context: o,
                handler: t,
                once: i
            })
        ...
        const Ae = C("emojiCategory", "categoryName", "noRecents", "recentEmojis");
        class Ie extends W {
            constructor({template: e, category: t, showVariants: o, lazyLoader: i}) {
                ...
                this.baseUIElements = {
                    categoryName: W.byClass(Ae.categoryName)
                },
                this.category = t,
                this.showVariants = o,
                this.lazyLoader = i
        ...
        class Me extends W {
            ...
            initialize() {
                this.uiEvents = [W.uiEvent("focus", this.handleFocus)],
                super.initialize()
            }
            handleFocus() {
        ...
        class Ne extends W {
            ...
            initialize() {
                this.grid = new Re(this.options.emojisPerRow,this.emojiCount,0,0,!this.category),
                ...
                this.uiEvents = [W.uiEvent("click", this.selectEmoji), W.uiEvent("keydown", this.grid.handleKeyDown)],
                this.preview && this.uiEvents.push(W.uiEvent("mouseover", this.showPreview), W.uiEvent("mouseout", this.hidePreview), W.uiEvent("focus", this.showPreview, {
                    capture: !0
                }), W.uiEvent("blur", this.hidePreview, {
                    capture: !0
                })),
                super.initialize()
            }
            ...
            renderSync() {
                return this.emojiViews = this.emojis.map((e => this.viewFactory.create(Me, {
                    emoji: e,
        ...
        class Ke extends Ne {
            ...
            async addOrUpdate(e) {
                ...
                const o = this.viewFactory.create(Me, {
                    emoji: e
                });
        ...
        const Ge = C("emojiArea")
          , Ze = new re(( ({classes: e}) => `\n  <div class="${e.emojiArea}">\n    <div data-placeholder="emojis"></div>\n  </div>\n`),{
            mode: "async"
        })
          , Je = {
            recents: class extends Ie {
                ...
                initialize() {
                    this.uiElements = {
                        ...this.baseUIElements,
                        recents: W.byClass(Ae.recentEmojis)
                    },
                    this.appEvents = {
        ...
        class Ye extends W {
            constructor({categoryTabs: e, categories: t, emojiVersion: o}) {
                ...
                this.categories = t,
                this.emojiVersion = o,
                this.handleScroll = v(this.handleScroll.bind(this), 100)
            }
            initialize() {
                this.appEvents = {
                ...
                this.uiElements = {
                    emojis: W.byClass(Ge.emojiArea)
                },
                this.uiEvents = [W.uiEvent("scroll", this.handleScroll)],
                super.initialize()
            }
            get focusableEmoji() {
        ...
        const Qe = new re(( ({classList: e, classes: t, icon: o, message: i}) => `\n<div class="${e}" role="alert">\n  <div class="${t.iconContainer}"><i data-size="10x" data-icon="${o}"></i></div>\n  <h3 class="${t.title}">${i}</h3>\n</div>\n`))
          , Xe = C("error", "iconContainer", "title");
        class et extends W {
            constructor({message: e, icon: t="warning", template: o=Qe, className: i}) {
                super({
                    template: o,
                    classes: Xe
                }),
            ...
            renderSync() {
                const e = [Xe.error, this.className].join(" ").trim();
                return super.renderSync({
        ...
        class it extends et {
            ...
            initialize() {
                ...
                this.uiEvents = [W.childEvent("retryButton", "click", this.onRetry)],
                super.initialize()
            }
            async onRetry() {
                ...
                const e = await B(this.options.locale, this.options.dataStore, this.options.messages, this.options.emojiData, this.emojiData);
                this.viewFactory.setEmojiData(e),
                this.events.emit("data:ready", e)
            }
        }
        const st = C("preview", "previewEmoji", "previewName", "tagList", "tag")
        ...
        class nt extends W {
            ...
            initialize() {
                this.uiElements = {
                    emoji: W.byClass(st.previewEmoji),
                    name: W.byClass(st.previewName),
                    tagList: W.byClass(st.tagList)
                },
                this.appEvents = {
        ...
        const ct = new re(( ({classes: e, i18n: t}) => `\n  <button title="${t.get("search.clear")}" class="${e.clearSearchButton}">\n    <i data-icon="xmark"></i>\n  </button>\n`))
          ...
          , ht = C("searchContainer", "searchField", "clearButton", "searchAccessory", "clearSearchButton", "notFound");
        class dt extends W {
            constructor({categories: e, emojiVersion: t}) {
                ...
                this.emojiVersion = t,
                this.search = f(this.search.bind(this), 100)
            }
            initialize() {
                this.uiElements = {
                    searchField: W.byClass(ht.searchField),
                    searchAccessory: W.byClass(ht.searchAccessory)
                },
                this.uiEvents = [W.childEvent("searchField", "keydown", this.onKeyDown), W.childEvent("searchField", "input", this.onSearchInput)],
                super.initialize()
            }
            async render() {
            ...
            async search() {
                ...
                if (this.searchField.value)
                    try {
                        ...
                        t.length) {
                            const o = new qe;
                            this.resultsContainer = this.viewFactory.create(Ne, {
                                emojis: t,
                                fullHeight: !0,
                                showVariants: !0,
                                lazyLoader: o
        ...
        const mt = new re(( ({classes: e}) => `\n  <div class="${e.variantOverlay}">\n    <div class="${e.variantPopup}">\n      <div data-view="emojis" data-render="sync"></div>\n    </div>\n  </div>\n`))
          , ut = C("variantOverlay", "variantPopup")
          , pt = {
            easing: "ease-in-out",
            duration: 250,
            fill: "both"
        ...
        class vt extends W {
            constructor({emoji: e, parent: t}) {
                ...
                this.focusTrap = new H,
                this.animateShow = () => Promise.all([w(this.el, gt, pt, this.options), w(this.ui.popup, yt, pt, this.options)]),
                this.emoji = e
            }
            initialize() {
                this.uiElements = {
                    popup: W.byClass(ut.variantPopup)
                },
                this.uiEvents = [W.uiEvent("click", this.handleClick), W.uiEvent("keydown", this.handleKeydown)],
                super.initialize()
            }
            animateHide() {
                const e = {
        ...
        const ft = new re(( ({classes: e, i18n: t, category: o, pickerId: i, icon: s}) => `\n<li class="${e.categoryTab}">\n  <button\n    aria-selected="false"\n    role="tab"\n    class="${e.categoryButton}"\n    tabindex="-1"\n    title="${t.get(`categories.${o.key}`, o.message || o.key)}"\n    type="button"\n    data-category="${o.key}"\n    id="${i}-category-${o.key}"\n  >\n    <i data-icon="${s}"></i>\n</li>\n`))
          , wt = C("categoryTab", "categoryTabActive", "categoryButton");
        class bt extends W {
            ...
            initialize() {
                this.uiElements = {
                    button: W.byClass(wt.categoryButton)
                },
                this.uiEvents = [W.childEvent("button", "click", this.selectCategory), W.childEvent("button", "focus", this.selectCategory)],
                super.initialize()
            }
            renderSync() {
                return super.renderSync({
        ...
        const jt = new re(( ({classes: e}) => `\n  <div class="${e.categoryButtonsContainer}">\n    <ul role="tablist" class="${e.categoryButtons}">\n      <div data-placeholder="tabs"></div>\n    </ul>\n  </div>\n`))
          , Ct = C("categoryButtons", "categoryButtonsContainer");
        class kt extends W {
            ...
            initialize() {
                ...
                this.uiEvents = [W.uiEvent("scroll", this.checkOverflow)],
                super.initialize()
            }
            checkOverflow() {
        ...
        const zt = new re((e => e.isLoaded ? function(e) {
          ...
          , Pt = C("picker", "skeleton", "placeholder", "searchSkeleton", "searchInput", "categoryTabsSkeleton", "headerSkeleton", "categoryTab", "contentSkeleton", "categoryName", "emojiGrid", "emoji", "previewSkeleton", "previewEmoji", "previewName", "tagList", "tag", "overlay", "content", "fullHeight", "pluginContainer", "header")
          , Lt = {
        ...
        class Ft extends W {
            constructor() {
                ...
                this.updaters = {
                    styleProperty: e => t => this.el.style.setProperty(Lt[e], t.toString()),
                    theme: e => {
            ...
            initialize() {
                this.uiElements = {
                    pickerContent: W.byClass(Pt.content),
                    header: W.byClass(Pt.header)
                },
                this.uiEvents = [W.uiEvent("keydown", this.handleKeyDown)],
                this.appEvents = {
                    error: this.onError,
            ...
            buildChildViews() {
                return this.options.showPreview && (this.preview = this.viewFactory.create(nt)),
            ...
            setStyleProperties() {
                ...
                Object.keys(Lt).forEach((e => {
                    this.options[e] && this.el.style.setProperty(Lt[e], this.options[e].toString())
                }
                ))
            }
            updateStyleProperty(e, t) {
                this.el.style.setProperty(Lt[e], t.toString())
            }
            reinitialize() {
                this.renderSync()
            }
            ...
            async showVariantPopup(e) {
                ...
                this.variantPopup = this.viewFactory.create(vt, {
                    emoji: e,
                    parent: this.el
                }),
        ...
        class $t {
            constructor({events: e, i18n: t, renderer: o, emojiData: i, options: s, customEmojis: r=[], pickerId: a}) {
                this.events = e,
                this.i18n = t,
                this.renderer = o,
                this.emojiData = i,
        ...
        class It {
            constructor(e={}) {
                r(this, At, void 0),
                a(this, At, new Map(Object.entries(e)))
            }
            get(e, t=e) {
                return s(this, At).get(e) || t
            }
        }
        function Tt() {
            let e = !1;
            return function(t) {
                Le.injectStyles && !e && (function(e, t) {
                    void 0 === t && (t = {});
                    var o = t.insertAt;
        ...
        function Bt(e) {
            ...
            const t = ke(e)
              ...
              , i = new Fe;
            Mt || (Mt = function(e) {
                return B(e.locale, e.dataStore, e.messages, e.emojiData)
            }(t));
            const s = new It(t.i18n);
            Mt.then((e => {
                i.emit("data:ready", e)
            }
            )).catch((e => {
