"use strict";
(self.webpackChunkdashly = self.webpackChunkdashly || []).push([[689], {
    2639: (e, t, n) => {
        n.d(t, {
            kgr: () => Xe,
            H6J: () => cr,
        ...
        function J(e, t) {
            return ie(e) === ie(t) ? Math.round(G(e, t)) : null
        }
        function X(e) {
        ...
        var Pe = {
          ...
          , Qe = function() {
            function e(e) {
                ...
                this.severity = r,
                this.buildFormattingFunc = He(We)
            }
        ...
        function Ge(e) {
            return "object" == typeof e && e ? new Qe(e) : "string" == typeof e ? new qe(e) : "function" == typeof e ? new Ye(e) : null
        }
        var Je = {
            navLinkDayClick: it,
            navLinkWeekClick: it,
            ...
            buttonIcons: it,
            customButtons: it,
            defaultAllDayEventDuration: De,
            defaultTimedEventDuration: De,
            nextDayThreshold: De,
            scrollTime: De,
        ...
        function St(e) {
            var t = Math.floor(G(e.start, e.end)) || 1
              , n = X(e.start);
            return {
                start: n,
                end: j(n, t)
        ...
        function kt(e) {
            var t = Tt(e);
            return G(t.start, t.end) > 1
        }
        function xt(e, t, n, r) {
            return "year" === r ? De(n.diffWholeYears(e, t), "year") : "month" === r ? De(n.diffWholeMonths(e, t), "month") : (i = t,
            a = X(o = e),
            s = X(i),
            {
                years: 0,
        ...
        function Bt(e, t, n, r) {
            ...
            for (var m in o)
                for (var y = 0, A = Rt(o[m], n); y < A.length; y++) {
                    var b, D = A[y];
                    p = c[(b = a[m]).defId];
                    s.push({
                        def: b,
            ...
            for (var u in i)
                for (var E = 0, w = Rt(i[u], n); E < w.length; E++) {
                    D = w[E];
                    s.push({
                        def: e.defs[u],
                        ui: c[u],
        ...
        function jt(e, t, n, r, o, i, a) {
            ...
            var p = f.range.start
              ...
              , y = X(q(h, -1)).valueOf() === X(q(g, -1)).valueOf();
        ...
        var pn = function() {
            ...
            e.prototype.formatDate = function(e, t) {
                ...
                return n.format(n.createMarker(e), Ge(t))
            }
            ,
            e.prototype.formatRange = function(e, t, n) {
                var r = this.getCurrentData().dateEnv;
                return r.formatRange(r.createMarker(e), r.createMarker(t), Ge(n), n)
            }
            ,
          ...
          , hn = function() {
            ...
            e.prototype.setStart = function(e, t) {
                ...
                var n = this._context.dateEnv
                  , r = n.createMarker(e);
                if (r && this._instance) {
                    var o = xt(this._instance.range.start, r, n, t.granularity);
            ...
            e.prototype.setEnd = function(e, t) {
                ...
                if ((null == e || (n = r.createMarker(e))) && this._instance)
                    if (n) {
                        var o = xt(this._instance.range.end, n, r, t.granularity);
                        this.mutate({
                            endDelta: o
                        })
                    } else
            ...
            e.prototype.setDates = function(e, t, n) {
                ...
                if (l && ((null == t || (r = a.createMarker(t))) && this._instance)) {
                    ...
                    !0 === n.allDay && (c = St(c));
                    var u = xt(c.start, l, a, n.granularity);
                    if (r) {
                        var d = xt(c.end, r, a, n.granularity);
                        i = d,
        ...
        function Jn(e, t, n) {
            ...
            var r = n ? e.getBoundingClientRect() : Xn(e)
              , o = function(e, t) {
                ...
                return qn() && "rtl" === n.direction ? c.scrollbarLeft = l : c.scrollbarRight = l,
        ...
        function sr(e, t, n, r, o, i, a, s, l, c, u, d, f) {
            return {
                ...
                createScrollResponder: function(e) {
                    return new ir(e,c,De(n.scrollTime),n.scrollTimeReset)
                },
        ...
        var Mr = function() {
            ...
            e.prototype.buildCurrentRangeInfo = function(e, t) {
                ...
                a = this.buildRangeFromDayCount(e, t, n)) : (a = this.buildCustomVisibleRange(e)) ? i = r.dateEnv.greatestWholeUnit(a.start, a.end).unit : (i = xe(o = this.getFallbackDuration()).unit,
            ...
            e.prototype.buildDateIncrement = function(e) {
                ...
                return n || ((t = this.props.dateAlignment) ? De(1, t) : e || De({
                    days: 1
                }))
            }
            ,
        ...
        function Yr(e, t, n, r, o) {
            return {
                header: e.headerToolbar ? Gr(e.headerToolbar, e, t, n, r, o) : null,
                footer: e.footerToolbar ? Gr(e.footerToolbar, e, t, n, r, o) : null
            }
        }
                ...
                widgets: f.map((function(e) {
                    return e.split(",").map((function(e) {
                        ...
                        if (n = s[e])
                            ...
                            y = F(f.buttonTitleOverride || f.buttonTitleDefault || t.viewHint, [A, e], A)
                        } else if (i[e])
                            if (v = function() {
                                i[e]()
                            }
                            ...
                            "prevYear" === e || "nextYear" === e) {
                                ...
                                y = F(u[b] || d[b], [c.year || "year", "year"], c[e])
                            } else
                                y = function(t) {
                                    return F(u[e] || d[e], [c[t] || t, t], c[e])
                                }
                                ;
                        return {
                            buttonName: e,
        ...
        function ro(e, t, n) {
            ...
            n.formatRange(r.start, r.end, Ge(t.titleFormat || function(e) {
        ...
        var oo = function() {
            function e(e) {
                ...
                this.parseToolbars = He(Yr),
                this.buildViewSpecs = He(Rr),
            ...
            e.prototype._handleAction = function(e) {
                ...
                for (var p = Nr(o.eventSources, e, f, u), h = Vr(o.eventStore, e, p, f, u), v = Hr(p) && !c.options.progressiveEventRendering && o.renderableEventStore || h, g = this.buildViewUiProps(u), m = g.eventUiSingleBase, y = g.selectionConfig, A = this.buildEventUiBySource(p), b = {
                    ...
                    dateSelection: Wr(o.dateSelection, e),
                    eventSelection: Zr(o.eventSelection, e),
                    eventDrag: jr(o.eventDrag, e),
                    eventResize: qr(o.eventResize, e)
                }, D = (0,
                r.pi)((0,
                r.pi)({}, u), b), E = 0, w = s.pluginHooks.reducers; E < w.length; E++) {
                    var C = w[E];
                    (0,
                    r.pi)(b, C(o, e, D))
                }
        ...
        var go = function() {
            ...
            e.prototype.insertEntryAt = function(e, t) {
                var n = this.entriesByLevel
                  , r = this.levelCoords;
                -1 === t.lateral ? (Do(r, t.level, t.levelCoord),
                Do(n, t.level, [e])) : Do(n[t.level], t.lateral, e),
            ...
            e.prototype.findInsertion = function(e) {
                ...
                if (u)
                    for (A = l + 1; A < a && n[A] < s; )
                        A += 1;
                var b = -1;
                return A < a && n[A] === s && (b = Eo(r[A], e.span.end, mo)[0]),
                {
                    touchingLevel: l,
                    touchingLateral: c,
                    touchingEntry: u,
        ...
        var Vo = function(e) {
            ...
            t.prototype.render = function() {
                var e = this.context
                  ...
                  , l = s.date
                  , c = s.dateProfile
                  , u = Fn(l, s.todayRange, null, c)
                  , d = [_o].concat(Vn(u, o))
                  , f = t.format(l, s.dayHeaderFormat)
                  , p = !u.isDisabled && s.colCnt > 1 ? Wn(this.context, l) : {}
                  , h = (0,
                r.pi)((0,
                r.pi)((0,
                r.pi)({
          ...
          , Qo = function(e) {
            ...
            t.prototype.render = function() {
                var e = this.props
                  ...
                  , u = [_o].concat(Vn(c, o), e.extraClassNames || [])
          ...
          , Wo = function(e) {
            ...
            t.prototype.computeTiming = function() {
                var e = this.props
                  , t = this.context
                  , n = q(this.initialNowDate, (new Date).valueOf() - this.initialNowQueriedMs)
                  , r = t.dateEnv.startOf(n, e.unit)
                  , o = t.dateEnv.add(r, De(1, e.unit))
        ...
        var jo = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.createDayHeaderFormatter = He(qo),
                t
            }
            return (0,
            r.ZT)(t, e),
        ...
        function Xo(e, t) {
            var n = e.activeRange;
            return t ? n : {
                start: q(n.start, e.slotMinTime.milliseconds),
                end: q(n.end, e.slotMaxTime.milliseconds - 864e5)
            }
        }
        function Ko(e, t, n) {
                ...
                for (var m in c) {
                    ...
                    for (var C in p) {
                        ...
                        if (Ot(A, S.range)) {
                            ...
                            if (!1 === b.overlap)
                                return !1;
                            if (w && !w(new hn(t,f[S.defId],S), new hn(t,D,y)))
                                return !1
                        }
                    }
                    for (var T = i.eventStore, k = 0, x = b.allows; k < x.length; k++) {
                        var R = x[k]
                          , I = (0,
                        r.pi)((0,
                        r.pi)({}, n), {
                          ...
                          , O = T.instances[m]
                          , N = void 0;
                        if (N = M ? new hn(t,M,O) : new hn(t,D),
                        !R(nn(I, t), N))
                            return !1
                    }
                }
            ...
            t.prototype.render = function() {
                var e = this.props
                  ...
                  , s = {
                    ...
                    isStartResizable: !e.disableResizing && Wt(r, t),
          ...
          , bi = function(e) {
            ...
            t.prototype.render = function() {
                ...
                return i(Ai, {
                    ...
                    defaultContent: e.defaultContent || Di,
        ...
        var Ti = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.refineHookProps = Be(Si),
    ...
    9563: (e, t, n) => {
          ...
          , i = function(e) {
            ...
            t.prototype.render = function() {
                ...
                o.pi)({
                    ...
                    sideText: v,
                    navLinkAttrs: (0,
                    r.rcD)(this.context, u),
                    sideNavLinkAttrs: (0,
                    r.rcD)(this.context, u, "day", !1)
                }, p)
                  , m = ["fc-list-day"].concat((0,
                r.yLW)(p, t));
                return (0,
                r.azq)(r.QJ3, {
                    hookProps: g,
        ...
        function a(e) {
            return (0,
            r.azq)(r.HYg, null, e.text && (0,
            r.azq)("a", (0,
            o.pi)({
                id: e.textId,
                className: "fc-list-day-text"
            }, e.navLinkAttrs), e.text), e.sideText && (0,
            r.azq)("a", (0,
            o.pi)({
                "aria-hidden": !0,
                    ...
                    r.azq)("tr", {
                        ...
                        if (!1 !== a.displayEventTime) {
                            var s = e.eventRange.def
                              ...
                              , d = void 0;
                            if (s.allDay ? u = !0 : (0,
                            r.p7j)(e.eventRange.range) ? e.isStart ? d = (0,
                            r.r39)(e, t, n, null, null, l.range.start, e.end) : e.isEnd ? d = (0,
                            r.r39)(e, t, n, null, null, e.start, l.range.end) : u = !0 : d = (0,
                            r.r39)(e, t, n),
                            u) {
                                var f = {
        ...
        var u = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.computeDateVars = (0,
                r.HPs)(f),
                t.eventStoreToSegs = (0,
                r.HPs)(t._eventStoreToSegs),
                t.state = {
                    timeHeaderId: (0,
                    r.osf)(),
                    eventHeaderId: (0,
                ...
                r.azq)(r.wh8, {
                    ...
                    for (var c = [], h = 0; h < p.length; h += 1) {
                        ...
                        if (v) {
                            ...
                            for (var y = 0, A = v = (0,
                            r.hak)(v, s.eventOrder); y < A.length; y++) {
                                var b = A[y];
                                c.push((0,
                                r.azq)(l, (0,
                                o.pi)({
                                    key: g + ":" + b.eventRange.instance.instanceId,
                                    seg: b,
                                    isDragging: !1,
                                    isResizing: !1,
                                    isDateSelecting: !1,
            ...
            t.prototype._eventStoreToSegs = function(e, t, n) {
                return this.eventRangesToSegs((0,
                r.y$4)(e, t, this.props.dateProfile.activeRange, this.context.options.nextDayThreshold).fg, n)
            }
            ,
            ...
            t.prototype.eventRangeToSegs = function(e, t) {
                var n, o, i, a = this.context.dateEnv, s = this.context.options.nextDayThreshold, l = e.range, c = e.def.allDay, u = [];
                for (n = 0; n < t.length; n += 1)
                    ...
                    u.push(i),
                    !i.isEnd && !c && n + 1 < t.length && l.end < a.add(t[n + 1].start, s))) {
                        i.end = l.end,
                        i.isEnd = !0;
                        break
                    }
        ...
        function f(e) {
            for (var t = (0,
            r.b7Q)(e.renderRange.start), n = e.renderRange.end, o = [], i = []; t < n; )
                o.push(t),
                i.push({
                    start: t,
                    end: (0,
